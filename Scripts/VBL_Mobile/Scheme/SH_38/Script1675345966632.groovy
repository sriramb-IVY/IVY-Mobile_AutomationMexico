...
SchemeAppyNo = findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('SchemeAppyNo', Scheme_Index)
...
if (Mobile.verifyMatch(SchemeAppyNo, Expected_SchemeAppyNo, false, FailureHandling.STOP_ON_FAILURE)) {
    ...
    WebUI.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Select_Retailer and Going_OrderInvoice_Screen'), [('RetailerName') : findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
    ...
    GlobalVariable.ProductName = findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('BuyProduct2', Scheme_Index)
    ...
    'Free sku 02'
    GlobalVariable.Scheme_Free_SKU = findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Slab1', Scheme_Index)
    ...
    Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

    Mobile.takeScreenshot()

    KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')

    Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index))
    ...
    Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1_MAX', Scheme_Index))
    ...
    Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
    ...
    Slab_Qty_Free01 = findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index)
    ...
    Slab_Qty_Free02 = findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index)
...
//
//FreeProduct_Case_Slab1 = findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index)
//
//SIH_GET_SKU01 = (Integer.parseInt(FreeProduct_Case_Slab1) * Integer.parseInt(Actual_CaseSize_Free01))
//
//FreeProduct02_Case_Slab1 = findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index)
//
