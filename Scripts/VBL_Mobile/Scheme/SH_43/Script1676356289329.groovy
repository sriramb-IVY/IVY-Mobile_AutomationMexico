...
'AND Logic'
GlobalVariable.ProductName = findTestData('VBL_Mobile Input Data/Attribute_Scheme').getValue('BuyProduct1', Scheme_Index)
...
FreeProduct_Case_Slab1 = findTestData('VBL_Mobile Input Data/Attribute_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index)
