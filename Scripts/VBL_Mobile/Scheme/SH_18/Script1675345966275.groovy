...
//Two_SKU_Case_Qty = (Double.parseDouble(Slab_Qty) )
...
Slab1_FreeSku_CaseQty = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/Summary_ProductBasedCaseQty(Global_Index_1)'), 5)
...
SIH_BUY_SKU01 = Integer.parseInt(Slab_1_Min_Qty) * Integer.parseInt(Actual_CaseSize)
 ...
 ExcelKeywords.setValueToCellByIndex(sheet1, 16, 5, SIH_GET_SKU01)
