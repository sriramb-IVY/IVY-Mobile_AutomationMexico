...
KeywordUtil.logInfo(Slab1_FreeSku_Amt.toString() + ' : Free sky total amt')
...
Integer.parseInt(Slab_1_Min_Qty)

FreeProduct_Case_Slab1 = findTestData('VBL_Mobile Input Data/Automatio_Apportionate_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index)

//SKU_Conversion_Qty = findTestData('VBL_Mobile Input Data/Scheme_Stock_Validation').getValue('SKU_Conversion_Qty', 4)

SIH_BUYandGET_SKU01 = ((Integer.parseInt(Slab_1_Min_Qty) + Integer.parseInt(FreeProduct_Case_Slab1)) * Integer.parseInt(GlobalVariable.CaseSize))
...
ExcelKeywords.setValueToCellByIndex(sheet1, 4, 5, SIH_BUYandGET_SKU01)
