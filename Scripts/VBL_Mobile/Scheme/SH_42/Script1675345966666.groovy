...
WebUI.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Select_Retailer and Going_OrderInvoice_Screen'), [('RetailerName') : findTestData('VBL_Mobile Input Data/Scheme').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)

//slab_1
'Slab 1'

'AND Logic'
GlobalVariable.ProductName = findTestData('VBL_Mobile Input Data/Scheme').getValue('BuyProduct1', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('VBL_Mobile Input Data/Scheme').getValue('Slab_1_Min_Qty', Scheme_Index)
...
GlobalVariable.ProductName = findTestData('VBL_Mobile Input Data/Scheme').getValue('BuyProduct2', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('VBL_Mobile Input Data/Scheme').getValue('Sku2_Slab_1_Min_Qty', Scheme_Index)
...
Mobile.verifyMatch(SchemeName, findTestData('VBL_Mobile Input Data/Scheme').getValue('SchemeName', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(SchemeName + ' : Slab_1 Scheme Name correctly applied !')

Mobile.verifyMatch(SchemeDesc, findTestData('VBL_Mobile Input Data/Scheme').getValue('SchemeDescSlab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(SchemeDesc + ' : Slab_1 Scheme Description correctly displayed !')

//Web_Addition_dis_Amt = findTestData('VBL_Mobile Input Data/Scheme').getValue('Additional_Dis_Amt', Scheme_Index)
...
GlobalVariable.Scheme_Free_SKU = findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct_Slab1', Scheme_Index)
...
Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')

Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct_Case_Slab1_MAX', Scheme_Index))
...
//2nd free product
GlobalVariable.Scheme_Free_SKU = findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct02_Slab1', Scheme_Index)
...
Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')

Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct02_Case_Slab1_MAX', Scheme_Index))
...
Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
//
//Slab1_FreeSku_PieceQty = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/Summary_ProductBasedPieceQty(Global)'), 
//    5)
//
//Slab1_FreeSku_Amt2 = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/Summary_ProductBasedTotalAmt(Global)'), 
//    5)
//
Mobile.verifyMatch(Slab1_FreeSku, GlobalVariable.Scheme_Free_SKU, false, FailureHandling.STOP_ON_FAILURE)
...
//
//Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('VBL_Mobile Input Data/Scheme').getValue('FreeProduct02_Case_Slab1', 
