...
GlobalVariable.ProductName = findTestData('VBL_Mobile Input Data/Combination_Scheme').getValue('BuyProduct2', Scheme_Index)
...
Calculated_Additional_Discount = (Two_SKU_Case_Qty * Double.parseDouble(Web_Addition_dis_Amt))
...
//Slab_1_Min_Qty = findTestData('VBL_Mobile Input Data/Combination_Scheme').getValue('Slab_1_Min_Qty', Scheme_Index)
//
////SKU_Conversion_Qty = findTestData('VBL_Mobile Input Data/Scheme_Stock_Validation').getValue('SKU_Conversion_Qty', 8)
//
//SIH_BUY_SKU01 = Integer.parseInt(Slab_1_Min_Qty) * Integer.parseInt(Actual_CaseSize) 
//
////Slab_1_Min_Qty = findTestData('VBL_Mobile Input Data/Combination_Scheme').getValue('Slab_1_Min_Qty', Scheme_Index)
////
////SKU_Conversion_Qty = findTestData('VBL_Mobile Input Data/Scheme_Stock_Validation').getValue('SKU_Conversion_Qty', 9)
//
...
// 
// //SKU_Conversion_Qty = findTestData('VBL_Mobile Input Data/Scheme_Stock_Validation').getValue('SKU_Conversion_Qty', 10)
//
...
// 
// ExcelKeywords.setValueToCellByIndex(sheet1, 9, 5, SIH_BUY_SKU02)
// 
// ExcelKeywords.setValueToCellByIndex(sheet1, 10, 5, SIH_GET_SKU01)
// 
