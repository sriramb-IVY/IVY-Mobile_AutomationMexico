...
WebUI.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Select_Retailer and Going_OrderInvoice_Screen'), [('RetailerName') : findTestData(
            'VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.keypadValue = findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Slab_1_Min_Qty', 
    Scheme_Index)
...
GlobalVariable.Scheme_Free_SKU = findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Slab1', 
    Scheme_Index)
...
Mobile.setText(findTestObject('XXXXXXXXXXXX/Mobile Part/Reusable Object/Product Enter Search'), GlobalVariable.Scheme_Free_SKU, 
    5)
...
Actual_PiecePrice_FP = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/ProductDetails/PiecePrice_Value_Field'), 
    0)

Actual_CaseSize_FP = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/ProductDetails/CaseSize_Value_Field'), 
    0)
...
'Scheme checkbox must be enable!'
Mobile.takeScreenshot()

CheckBox = Mobile.getAttribute(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/Scheme_FreeProductQty_CheckBox'), 
    'checked', 1, FailureHandling.STOP_ON_FAILURE)

KeywordUtil.logInfo(CheckBox + ': Scheme Applied Checkbox ')

if (CheckBox == 'true') {
    KeywordUtil.logInfo(CheckBox + ': Scheme Applied Checkbox enabled')

    Mobile.takeScreenshot()
} else {
    KeywordUtil.logInfo(CheckBox + ': Scheme Applied Checkbox not enabled')
...
Mobile.verifyMatch(SchemeName, findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('SchemeName', Scheme_Index), 
...
Mobile.verifyMatch(SchemeDesc, findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('SchemeDescSlab1', 
...
Total_Scheme_Discount_amt = (((Double.parseDouble(Slab_Qty) * Double.parseDouble(Web_Addition_dis_Amt)) / Double.parseDouble(
    SKU_TOTAL)) * Double.parseDouble(SKU_TOTAL))
...
Mobile.waitForElementPresent(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/SchemeViewScreen_FreeSKU'), 
    5)

FreeProduct_Slab1 = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/SchemeViewScreen_FreeSKU'), 
    5)

FreeSKU_Qty_Slab1 = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/SchemeViewScreen_FreeSKU_Qty(Global)'), 
    5)

FreeSKU_MinQty_Slab1 = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/SchemeViewScreen_FreeSKU_MinQty(Global)'), 
    5)

FreeSKU_MaxQty_Slab1 = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/SchemeViewScreen_FreeSKU_MaxQty(Global)'), 
    5)
...
Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', 
        Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', 
    Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1_MAX', 
    Scheme_Index))
...
Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/Summary_FreeSkuTitle(Global)'), 
    5)

Slab1_FreeSku = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/Summary_FreeSkuTitle(Global)'), 
    5)

Slab1_FreeSku_CaseQty = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/Summary_ProductBasedCaseQty(Global)'), 
    5)

Slab1_FreeSku_Amt = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/Summary_ProductBasedTotalAmt(Global)'), 
    5)
...
Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', 
        Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Slab1_FreeSku_Amt = ((Double.parseDouble(Actual_CaseSize_FP) * Double.parseDouble(FreeSKU_Qty_Slab1)) * Double.parseDouble(
    Actual_PiecePrice_FP))
...
FreeProduct_Case_Slab1 = findTestData('VBL_Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', 
    Scheme_Index)

SIH_GET_SKU01 = (Integer.parseInt(FreeProduct_Case_Slab1) * Integer.parseInt(Actual_CaseSize_FP))
...
ExcelKeywords.setValueToCellByIndex(sheet1, 20, 5, SIH_BUY_SKU01)

ExcelKeywords.setValueToCellByIndex(sheet1, 21, 5, SIH_GET_SKU01)
