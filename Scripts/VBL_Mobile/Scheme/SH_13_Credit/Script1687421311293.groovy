...
KeywordUtil.logInfo(Web_Addition_dis_Amt)
...
KeywordUtil.logInfo(Two_SKU_Case_Qty.toString())

SumOfTheLineValue = (Double.parseDouble(SKU_1_TOTAL) + Double.parseDouble(SKU_2_TOTAL))

KeywordUtil.logInfo(SumOfTheLineValue.toString())

SKU_1_DiscountAmt = (((Two_SKU_Case_Qty * Double.parseDouble(Web_Addition_dis_Amt)) / SumOfTheLineValue) * Double.parseDouble(SKU_1_TOTAL))

KeywordUtil.logInfo(SKU_1_DiscountAmt.toString())

SKU_2_DiscountAmt = (((Two_SKU_Case_Qty * Double.parseDouble(Web_Addition_dis_Amt)) / SumOfTheLineValue) * Double.parseDouble(SKU_2_TOTAL))

KeywordUtil.logInfo(SKU_2_DiscountAmt.toString())
...
'This is credit not retailer thats why scheme diplayed as zero'
...
ExcelKeywords.setValueToCellByIndex(sheet1, 6, 6, GlobalVariable.InvoiceNo )

ExcelKeywords.setValueToCellByIndex(sheet1, 6, 12, GlobalVariable.DiscountAmt)
