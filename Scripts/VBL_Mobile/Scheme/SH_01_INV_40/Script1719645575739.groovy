...
WebUI.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Select_Retailer and Going_OrderInvoice_Screen'), [('RetailerName') : findTestData(
            'VBL_Mobile Input Data/OTPR').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
...
'When Users unselect the checkbox of available scheme, Scheme should not be applied in the summary screen.'
Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/SchemeName'), 15)

Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/Scheme_Percentage_CheckBox'), 0)
...
not_run: Mobile.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Tap_Next_Btn_ApplyschemeScrn_CT'), [:], FailureHandling.STOP_ON_FAILURE)
...
'When users select the checkbox of available scheme, Scheme should be applied in the summary screen.'
Mobile.takeScreenshot()
...
Mobile.verifyMatch(SchemeDesc, findTestData('VBL_Mobile Input Data/OTPR').getValue('SchemeDescSlab1', Scheme_Index), false, 
...
Mobile.verifyMatch(SchemeDesc, findTestData('VBL_Mobile Input Data/OTPR').getValue('SchemeDescSlab2', Scheme_Index), false, 
    FailureHandling.STOP_ON_FAILURE)
...
SIH_BUY_SKU01 = (Integer.parseInt(Slab_2_Min_Qty) * Integer.parseInt(Actual_CaseSize))
...
ExcelKeywords.setValueToCellByIndex(sheet1, 8, 5, SIH_BUY_SKU01)
