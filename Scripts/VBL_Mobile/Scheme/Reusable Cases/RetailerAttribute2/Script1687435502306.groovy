...
GlobalVariable.label = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Distributor', 1)
...
GlobalVariable.label = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Channel_Name', 1)
...
for (int i = 0; i < Retailer.size(); i++) {
    if (Retailer.get(i) != 'null') {
        ...
        WebUI.scrollToElement(findTestObject('XXXXXXXXXXXX/Web Part/RetailerAttribute/SchemeApplyType'), 100)

        SchemeApplyType1 = WebUI.getAttribute(findTestObject('XXXXXXXXXXXX/Web Part/RetailerAttribute/SchemeApplyType'), 'value')
        ...
        //            GlobalVariable.label1 = SchemeApplyType1.replaceAll('Fixed_DD', 'Fixed and Variable')
        //        } else {
        //            GlobalVariable.label1 = SchemeApplyType1.replaceAll('\\s', '')
        //        }
        //        
        ...
        Sheetname = 'OTP_Automation_Scheme_CMB'
