...
WebUI.setText(findTestObject('XXXXXXXXXXXX/Web Part/Module Configuration/Code_search_field'), findTestData('VBL_Web Input Data/Module Configuration').getValue('Configs', 2))
...
unchecked_checkbox = findTestData('VBL_Web Input Data/Module Configuration').getValue('Check_Box', 2)
...
if (checkbox_type == unchecked_checkbox) {
    ...
    KeywordUtil.logInfo('Checkbox is already disabled')
}

GlobalVariable.label = findTestData('VBL_Web Input Data/Module Configuration').getValue('Configs', 3)

WebUI.setText(findTestObject('XXXXXXXXXXXX/Web Part/Module Configuration/Code_search_field'), findTestData('VBL_Web Input Data/Module Configuration').getValue('Configs', 3))
...
WebUI.clearText(findTestObject('XXXXXXXXXXXX/Web Part/Module Configuration/Code_search_field'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('XXXXXXXXXXXX/Web Part/Module Configuration/Code_search_field'), 'PR')

WebUI.delay(2)

WebUI.click(findTestObject('XXXXXXXXXXXX/Web Part/Module Configuration/Save_btn'))

Save_popup = WebUI.getText(findTestObject('XXXXXXXXXXXX/Web Part/Module Configuration/Save_popup'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(Save_popup, findTestData('VBL_Web Input Data/Module Configuration').getValue('Popup', 1), false, FailureHandling.STOP_ON_FAILURE)
