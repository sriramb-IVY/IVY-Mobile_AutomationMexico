...
if (Mobile.verifyMatch(SchemeAppyNo, Expected_SchemeAppyNo, false, FailureHandling.STOP_ON_FAILURE)) {
    KeywordUtil.logInfo('For this Retailer "SchemeAppyNo" and "Expected_SchemeAppyNo" was Equal, hence we can validate scheme !')
        ...
        WebUI.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Select_Retailer and Going_OrderInvoice_Screen'), [('RetailerName') : findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue(
        ...
        Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/FilterScreen/FilterScreen-Apply btn'), 
            5)
        ...
        Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Tab-Product Details'), 
            5)
		...
		Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/SchemeName'),
		...
		KeywordUtil.logInfo(CheckBox + ': Scheme Applied Checkbox ')
			...
			Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Next Btn-ApplySchemeScreen'), 0)
			...
			Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('VBL_Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct_Case_Slab1',
