...
GlobalVariable.SO_Number = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('OrderNumber', 3)
...
if (recordSet1.next()) {
    ...
    //percentage
    DiscountAmt = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('DiscountAmt', 3)
    ...
    //Scheme Amt
    Object SIH_Scheme_Amount = recordSet1.getObject('SISD_Value')

    SchemeAmt = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('SchemeAmt', 3)
...
if (recordSet2.next()) {
    ...
    SchemeName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('SchemeName', 3)
...
if (recordSet3.next()) {
    ...
    ProductName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('ProductName', 3)
...
GlobalVariable.ProductName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('ProductName', 3)
...
WebUI.verifyMatch(Price, findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Price', 3), false, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(Qty, findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Qty', 3), false, FailureHandling.STOP_ON_FAILURE)
...
TotalAmt = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Total_Amt', 3)
...
TaxValue = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Tax', 3)
...
GrossAmt = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Gross_Amt', 3)
...
Expected_SchemeName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('SchemeName', 3)
