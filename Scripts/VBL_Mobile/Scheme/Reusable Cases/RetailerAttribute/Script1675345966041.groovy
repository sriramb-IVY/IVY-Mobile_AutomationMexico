...
GlobalVariable.label = findTestData('VBL_Mobile Input Data/Fixed_Variable_Scheme').getValue('Distributor', 1)
...
GlobalVariable.label = findTestData('VBL_Mobile Input Data/Fixed_Variable_Scheme').getValue('Channel_Name', 1)
