...
GlobalVariable.SO_Number = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('OrderNumber', 2)
...
if (recordSet1.next()) {
    Object Percentage = recordSet1.getObject('SISD_Percentage')

    //percentage
    DiscountPerc = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('DiscountPerc', 2)

    Mobile.verifyEqual(Percentage, Double.parseDouble(DiscountPerc), FailureHandling.STOP_ON_FAILURE)

    println('Scheme Discount percentage from the mobile should be properly inserted into database')

    //Scheme Amt
    Object SISD_Value = recordSet1.getObject('SISD_Value')

    SchemeAmt = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('SchemeAmt', 2)
...
if(recordSet2.next()) {
    ...
    SchemeName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('SchemeName', 2)
...
if(recordSet3.next()) {
    ...
    ProductName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('ProductName', 2)
...
GlobalVariable.ProductName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('ProductName', 2)
...
WebUI.verifyMatch(Price, findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Price', 2), false, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(Qty, findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Qty', 2), false, FailureHandling.STOP_ON_FAILURE)
...
TotalAmt = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Total_Amt', 2)
...
//
//TaxValue = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Tax', 2)
//
...
GrossAmt = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('Gross_Amt', 2)
...
Expected_SchemeName = findTestData('VBL_Web Input Data/Sales_Order_Invoice_View').getValue('SchemeName', 2)
