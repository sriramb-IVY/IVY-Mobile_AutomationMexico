...
sheet_name = 'Fixed_Variable_Scheme'

file_name = 'Mobile Input data'

ArrayList<String> BuyProduct1 = CustomKeywords.'poi.VBL.Automation.GetAllDataRow_Flag.getAllDataRow'(file_name, sheet_name, 
    'BuyProduct1')

ArrayList<String> BuyProduct2 = CustomKeywords.'poi.VBL.Automation.GetAllDataRow_Flag.getAllDataRow'(file_name, sheet_name, 
    'BuyProduct2')
...
for (int a = 0; a < BuyProduct1.size(); a++) {
    if (BuyProduct1.get(a) != 'null') {
        ...
        WebUI.scrollToElement(findTestObject('XXXXXXXXXXXX/Web Part/Product_Hierarchy/Piece_MRP_Value'), 0)

        String MRP = WebUI.getText(findTestObject('XXXXXXXXXXXX/Web Part/Product_Hierarchy/Piece_MRP_Value'))

		GlobalVariable.MRP = MRP.replace('/$ ', '')
        ...
        String Sheetname = 'Fixed_Variable_Scheme'
...
for (int b = 0; b < BuyProduct2.size(); b++) {
    if (BuyProduct2.get(b) != 'null') {
        ...
        MRP = WebUI.getText(findTestObject('XXXXXXXXXXXX/Web Part/Product_Hierarchy/Piece_MRP_Value'))
