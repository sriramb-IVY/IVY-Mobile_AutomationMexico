...
queryString = (('select top 3 * from AppData_Van_UnLoad_header where vuh_auh_id= \'' + GlobalVariable.vanseller_user_id + '\' and vuh_av_id=15 and vuh_date=\'' + DB_Currentdate) + '\'')
...
queryString0 = (('delete from AppData_Van_UnLoad_header where vuh_auh_id= \'' + GlobalVariable.vanseller_user_id + '\' and vuh_av_id=15 and VUH_Id=\'' + GlobalVariable.label) + '\'')
