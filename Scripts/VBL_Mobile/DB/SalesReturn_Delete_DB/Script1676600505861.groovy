...
queryString = (('select  * from appdata_sales_return_header where srh_Date = \'' + DB_Currentdate) + '\'   and SRH_UserId=297 ')
...
queryString01 = (('delete from appdata_sales_return_detail where srd_srh_id=\'' + GlobalVariable.label) + '\'')
...
queryString0 = (('delete from appdata_sales_return_reasons   where srr_srh_id =\'' + GlobalVariable.label) + '\' ')
