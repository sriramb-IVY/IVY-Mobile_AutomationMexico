...
queryString = (((('delete from AppData_Stock_Reconcilation_Header where ASRH_AUH_Id =\'' + GlobalVariable.vanseller_user_id) + '\' and ASRH_Date = \'') + GlobalVariable.sDate) + '\'')
...
queryString = ('delete from AppData_Stock_Reconcilation_Detail')
...
queryString = ('delete from AppData_Cash_Reconciliation_Header')
...
queryString = ('delete from AppData_Cash_Reconciliation_Detail')
