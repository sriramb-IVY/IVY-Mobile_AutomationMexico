...
queryString01 = (('delete from appdata_order_detail where od_oh_id=\'' + GlobalVariable.label) + '\'')
...
queryString0 = (('delete from appdata_order_scheme_detail where osd_oh_id= \'' + GlobalVariable.label) + '\'')
...
queryString1 = (('delete from appdata_order_tax_detail where otd_oh_id= \'' + GlobalVariable.label) + '\'')
...
queryString3 = (('delete from appdata_order_header where OH_User_Id = \'' + GlobalVariable.vanseller_user_id + '\' and OH_Id=\'' + GlobalVariable.label) + '\'')
