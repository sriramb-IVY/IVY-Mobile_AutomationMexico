...
queryString = (('select  * from AppData_Stock_Proposal_Header where SPH_AUH_Id =  \'' + GlobalVariable.vanseller_user_id + '\'  and SPH_Date =\'' + DB_Currentdate) + '\' ')
...
while (recordSet.next()) {
	String data1 = recordSet.getObject('SPH_Id')

	KeywordUtil.logInfo(data1)

	GlobalVariable.label = data1
	
	String data = recordSet.getObject('SPH_Date')
 
	KeywordUtil.logInfo(data)

queryString01 = (('delete from AppData_Stock_Proposal_Detail where SPD_SPH_Id=\'' + GlobalVariable.label) + '\' ')
...
queryString0 = (('delete from AppData_Stock_Proposal_Header where SPH_AUH_Id =  \'' + GlobalVariable.vanseller_user_id + '\'  and SPH_Id =\'' + GlobalVariable.label) + '\' ')
