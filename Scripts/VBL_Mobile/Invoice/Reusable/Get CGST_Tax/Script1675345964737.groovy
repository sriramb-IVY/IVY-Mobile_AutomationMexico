...
WebUI.click(findTestObject('XXXXXXXXXXXX/Web Part/TaxScreen/1st_Row_GridValue'))

WebUI.click(findTestObject('XXXXXXXXXXXX/Web Part/TaxScreen/Edit_Append_Btn'))
...
Mobile.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Web Login and Navigation/Navigate to Tax Group Creation'), [:], 
