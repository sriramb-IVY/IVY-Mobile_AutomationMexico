...
Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Case_Field'), 5)
...
Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/Reusable Object/Product Search Icon'), 5, FailureHandling.OPTIONAL)

Mobile.clearText(findTestObject('XXXXXXXXXXXX/Mobile Part/Reusable Object/Product Enter Search'), 3, FailureHandling.OPTIONAL)
