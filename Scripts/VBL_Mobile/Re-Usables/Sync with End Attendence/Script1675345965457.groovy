...
if (Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/MainMenu/Menu_Sync'), 0, FailureHandling.OPTIONAL)) {
    ...
    if (Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/Sync/SyncAlert-Orders exist without invoice creation'), 
    ...
    if (Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/Sync/SyncAlert-Attendance Activity Not Completed'), 
        2, FailureHandling.OPTIONAL)) {
        Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/Sync/Btn-OK'), 0)
        ...
        if (Mobile.verifyElementVisible(findTestObject('XXXXXXXXXXXX/Mobile Part/Attendance/AttendanceScreen-End Button'), 
    ...
    Mobile.waitForElementPresent(findTestObject('XXXXXXXXXXXX/Mobile Part/Sync/SyncAlert_Data upload completed Successfully'), 
        120, FailureHandling.OPTIONAL)
    ...
    Mobile.waitForElementPresent(findTestObject('XXXXXXXXXXXX/Mobile Part/Sync/SyncAlert_Downloaded Successfully'), 60, FailureHandling.OPTIONAL)

    Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/Sync/Btn-OK'), 0, FailureHandling.OPTIONAL)
}
