...
//not_run: Mobile.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Mobile_Login/VanSeller_withoutAttendance'), [:], FailureHandling.STOP_ON_FAILURE)
//
...
for (i = Starting_Row_No; i <= Ending_Row_No; i++) {
    ...
    Mobile.setText(findTestObject('XXXXXXXXXXXX/Mobile Part/End of the Day/ManualVanload/CaseField'), case_Quantity.get(i), 
