...
if (Mobile.verifyElementExist(findTestObject('XXXXXXXXXXXX/Mobile Part/MainMenu/Menu_End of the Day'), 2, FailureHandling.OPTIONAL)) {
...
ArrayList<String> case_Quantity = CustomKeywords.'poi.VBL.Automation.GetAllWebDataRow_Flag.getAllDataRow'(file_name, sheet_name, 'case_Quantity')

ArrayList<String> SKU_Name = CustomKeywords.'poi.VBL.Automation.GetAllWebDataRow_Flag.getAllDataRow'(file_name, sheet_name, 'SKU_Name')
...
Mobile.waitForElementPresent(findTestObject('XXXXXXXXXXXX/Re-usable/Mobile Login/Menu'), 15, FailureHandling.STOP_ON_FAILURE)

Mobile.delay(1)

Mobile.tap(findTestObject('XXXXXXXXXXXX/Re-usable/Mobile Login/Menu'), 15, FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/LoadManagement/Vanload/VanLoadScreen-Accept Btn'), 10, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('XXXXXXXXXXXX/Mobile Part/LoadManagement/Vanload/OK Btn'), 10, FailureHandling.STOP_ON_FAILURE)
