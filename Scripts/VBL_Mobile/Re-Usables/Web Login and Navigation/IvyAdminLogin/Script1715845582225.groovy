...
WebUI.setText(findTestObject('XXXXXXXXXXXX/Web Part/Re-usable/Login/Username'), GlobalVariable.VersionCodevyadminUsername, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('XXXXXXXXXXXX/Web Part/Re-usable/Login/Password'), GlobalVariable.VersionCodevyadminPassword, FailureHandling.STOP_ON_FAILURE)
