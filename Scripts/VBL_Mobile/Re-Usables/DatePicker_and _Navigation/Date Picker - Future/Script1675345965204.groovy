...
if (DateValue == 'tomorrow') {
    ...
    String tomorrow = dateFormat.format(date+5)
...
WebUI.click(findTestObject('XXXXXXXXXXXX/Re-usable/Date picker/Year_Option'))

WebUI.delay(1)

WebUI.click(findTestObject('XXXXXXXXXXXX/Re-usable/Date picker/Month_Option'))

WebUI.delay(1)

WebUI.click(findTestObject('XXXXXXXXXXXX/Re-usable/Date picker/Date'))
