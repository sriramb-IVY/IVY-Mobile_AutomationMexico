...
WebUI.click(findTestObject('Web Part/Seller KPI/Lines_per_call_option'))
...
GlobalVariable.label = findTestData('Web Input Data/Seller KPI').getValue('Options', 7)
...
if (WebUI.verifyElementVisible(findTestObject('Web Part/Seller KPI/DD_Value'), FailureHandling.OPTIONAL)) {
    ...
    LPC_amt = WebUI.getText(findTestObject('Web Part/Seller KPI/Entered_value_Amt'))
    ...
    WebUI.waitForElementVisible(findTestObject('Web Part/Seller KPI/text_button_tag'), 10, FailureHandling.OPTIONAL)
