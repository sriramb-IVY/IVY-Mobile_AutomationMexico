...
queryString = (('delete from AppData_Expense_Header  where AEH_SU_Id= \'' + GlobalVariable.vanseller_user_id) + '\'  ')

KeywordUtil.logInfo(queryString)

result = stm.executeUpdate(queryString)

queryString = (('delete from AppData_Expense_Detail  where AED_Created_By= \'' + GlobalVariable.vanseller_user_id) + '\'  ')
