...
WebUI.verifyElementVisible(findTestObject('Web Part/Expense/Input_Fields/remarks_field'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Web Part/Expense/Buttons/show_button'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Web Part/Expense/Buttons/reject_button'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Web Part/Expense/UI_Validation/no_data_found'), findTestData('Web Input Data/Expense Approval').getValue('Alerts', 1), FailureHandling.STOP_ON_FAILURE)
...
mobileTotalAmount = findTestData('Mobile Input Data/Expense').getValue('Amount', 3)
...
WebUI.verifyEqual(Double.parseDouble(mobileTotalAmount), Double.parseDouble(totalAmount), FailureHandling.STOP_ON_FAILURE)
...
'Checkbox validation:-'
WebUI.verifyElementVisible(findTestObject('Web Part/Expense/Grid_Detail/checkbox_ViewIcon'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot()

WebUI.click(findTestObject('Web Part/Expense/Grid_Detail/grid_arrow'))
...
//WebUI.verifyElementText(findTestObject('Web Part/Expense/Grid_Detail/grid_split_amount'), mobileTotalAmount, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Web Part/Expense/Grid_Detail/image_icon'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.clearText(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'))

WebUI.sendKeys(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), findTestData('Web Input Data/Expense Approval').getValue('Excess_Reimbursed_Amount', 1))

WebUI.click(findTestObject('Web Part/Expense/Grid_Detail/grid_split_amount'))

WebUI.verifyElementText(findTestObject('Web Part/Expense/UI_Validation/toast_msg_validation'), findTestData('Web Input Data/Expense Approval').getValue('Alerts', 2), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot()

'Less reimbursed amount validation:-'
int lessAmount = Integer.parseInt(mobileTotalAmount) - 5

WebUI.click(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'))

WebUI.clearText(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'))

WebUI.sendKeys(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), lessAmount.toString())

WebUI.click(findTestObject('Web Part/Expense/Grid_Detail/grid_split_amount'))

GlobalVariable.reimbursedAmt = (reimbursedAmount = WebUI.getAttribute(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), 'value'))

WebUI.verifyLessThan(Integer.parseInt(reimbursedAmount), Integer.parseInt(mobileTotalAmount), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot()

enteredReimbursedAmount = WebUI.getAttribute(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), 'value')

WebUI.verifyEqual(Integer.parseInt(enteredReimbursedAmount), lessAmount, FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Web Part/Expense/Grid_Detail/image_icon'))
...
'Approve button functionality: "No Data to Approve" toast validation:-'
...
WebUI.verifyElementText(findTestObject('Web Part/Expense/UI_Validation/toast_msg_validation'), findTestData('Web Input Data/Expense Approval').getValue('Alerts', 3), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Web Part/Expense/UI_Validation/toast_msg_validation'), findTestData('Web Input Data/Expense Approval').getValue('Alerts', 4), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot()

WebUI.click(findTestObject('Web Part/Expense/UI_Validation/close_toast_msg'), FailureHandling.OPTIONAL)

'Reject button functionality: "Unable to process your request" toast validation:-'
WebUI.click(findTestObject('Web Part/Expense/Grid_Detail/checkbox_ViewIcon'))
...
WebUI.verifyElementText(findTestObject('Web Part/Expense/UI_Validation/toast_msg_validation'), findTestData('Web Input Data/Expense Approval').getValue('Alerts', 5), FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.reimbursedAmt = getReimbursedAmt = WebUI.getAttribute(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), 'value')
...
if (getReimbursedAmt == '0') {
    ...
    WebUI.verifyElementText(findTestObject('Web Part/Expense/UI_Validation/toast_msg_validation'), findTestData('Web Input Data/Expense Approval').getValue('Alerts', 6), FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), travelExpense)
...
WebUI.sendKeys(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), dailyExpense)
...
WebUI.sendKeys(findTestObject('Web Part/Expense/Grid_Detail/grid_split_reimbursed'), others)
...
WebUI.verifyElementText(findTestObject('Web Part/Expense/UI_Validation/toast_msg_validation'), findTestData('Web Input Data/Expense Approval').getValue('Alerts', 7), FailureHandling.STOP_ON_FAILURE)
