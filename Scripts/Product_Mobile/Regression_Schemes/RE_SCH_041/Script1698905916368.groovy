...
String sheet_name = '25_B11_OTPR_SS_BUY(EXCL)_FP'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    if (((Quantity_variations.get(i) == 'Slab1') || (Quantity_variations.get(i) == 'Slab achieved and Remaining Qty')) || (Quantity_variations.get(i) == 'Less than Slab1')) {
        'Buy_SKU_2'
        GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('SKU_Name2', Scheme_Index)

        Mobile.setText(findTestObject('Mobile/Common/Field_Search_EnterText'), GlobalVariable.ProductName, 5)
    } else if (Quantity_variations.get(i) == 'Buy_excluded') {
        'Buy_Excluded_SKU1'
        GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Excluded_SKU_Name_1', Scheme_Index)
    ...
    Slab_1_Min_Qty = findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Piece_quantity', Scheme_Index)
    ...
    if ((Quantity_variations.get(i) == 'Slab1') || (Quantity_variations.get(i) == 'Slab achieved and Remaining Qty')) {
        ...
        Mobile.verifyMatch(SchemeName, findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        Mobile.verifyMatch(SchemeDesc, findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Free_Product', Scheme_Index)
        ...
        Mobile.verifyMatch(FreeSKU_Qty_Slab, findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

        Mobile.takeScreenshot()

        KeywordUtil.logInfo(FreeSKU_Qty_Slab + ' : Free Product Piece Qty correctly displayed !')

        Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Free_quantity', Scheme_Index))
        ...
        Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Free_quantity', Scheme_Index))
        ...
        if (Quantity_variations.get(i) == 'Slab achieved and Remaining Qty') {
            GetProductMin = findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Get_Product_Min', Scheme_Index)

            Buy_Max = findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Buy_Max', Scheme_Index)
        ...
        Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('Batch_Scheme_Inputs_01/25_B11_OTPR_SS_BUY(EXCL)_FP').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
    ...
    } else if ((Quantity_variations.get(i) == 'Buy_excluded') || (Quantity_variations.get(i) == 'Less than Slab1')) {
