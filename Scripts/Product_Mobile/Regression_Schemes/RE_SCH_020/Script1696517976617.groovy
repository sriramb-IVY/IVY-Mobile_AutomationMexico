...
'Buy_Product01'
String sheet_name = '7_B6_MTS_FP_SS_Get(AND)'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    if ((Quantity_variations.get(i) == 'Slab1') || (Quantity_variations.get(i) == 'Double_Slab1')) {
        ...
        GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Buy_Product01', Scheme_Index)
        ...
        Slab_1_Min_Qty = findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Piece_quantity', Scheme_Index)
        ...
        Mobile.verifyMatch(SchemeName, findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        Mobile.verifyMatch(SchemeDesc, findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Get01_FP_01', Scheme_Index)
        ...
        Expecetd_FreeSKU_MinQty_Slab = ('Min:' + findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Free_quantity', Scheme_Index))
        ...
        Expecetd_FreeSKU_MaxQty_Slab = ('Max:' + findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Free_quantity', Scheme_Index))
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Get01_FP_02', Scheme_Index)
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Get02_FP_01', Scheme_Index)
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Get02_FP_02', Scheme_Index)
        ...
        if (FreeSKU_1_Qty_Slab != 0) {
            ...
            Mobile.verifyMatch(FreeSKU_1_Qty_Slab, findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
            ...
            Mobile.verifyMatch(FreeSKU_2_Qty_Slab, findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        GlobalVariable.Qty = findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Free_quantity', Scheme_Index)

        Mobile.verifyMatch(Slab_FreeSku_PieceQty, findTestData('Batch_Scheme_Inputs_01/7_B6_MTS_FP_SS_Get(AND)').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        WebUI.callTestCase(findTestCase('Product_Mobile/Regression_Schemes/Call Test Cases/RE_SCH_020_CT_1'), [:], FailureHandling.STOP_ON_FAILURE)
    }
}
