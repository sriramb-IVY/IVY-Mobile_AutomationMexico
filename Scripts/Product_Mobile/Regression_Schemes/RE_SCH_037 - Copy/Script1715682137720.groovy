...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    if ((Quantity_variations.get(i) == 'SLAB1') || (Quantity_variations.get(i) == 'Double First Slab')) {
        ...
        Min_Qty_1 = findTestData('Batch_Scheme_Inputs_01/18_B9_MTR_FP_AD_DIS_SS(Variant)').getValue('Min_quantity', Scheme_Index)
        ...
        Min_Qty_2 = findTestData('Batch_Scheme_Inputs_01/18_B9_MTR_FP_AD_DIS_SS(Variant)').getValue('Min_quantity', Scheme_Index)
        ...
        //sku3
        'Buy_SKU_3'
        GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/18_B9_MTR_FP_AD_DIS_SS(Variant)').getValue('Buy_Group1_P3', Scheme_Index)
        ...
        Min_Qty_3 = findTestData('Batch_Scheme_Inputs_01/18_B9_MTR_FP_AD_DIS_SS(Variant)').getValue('Min_quantity', Scheme_Index)
        ...
        if (Quantity_variations.get(i) == 'Slab1') {
            'For Slab1 Additional discount will not apply'
        ...
        } else if ((Quantity_variations.get(i) == 'Slab2') || (Quantity_variations.get(i) == 'Double_S2')) {
