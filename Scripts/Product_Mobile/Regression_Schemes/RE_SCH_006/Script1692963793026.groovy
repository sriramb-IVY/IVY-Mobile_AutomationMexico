...
String sheet_name = '6_OTP_SS_Free_Qty(In And Cond.)'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    if (Quantity_variations.get(i) == 'First slab') {
        ...
        //slab_1
        'SKU_1'
        GlobalVariable.ProductName = findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('SKU_Name', Scheme_Index)
        ...
        Slab_1_Min_Qty = findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Piece_quantity', Scheme_Index)
        ...
        Mobile.verifyMatch(SchemeName, findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

        Mobile.takeScreenshot()

        KeywordUtil.logInfo(SchemeName + ' : Slab Scheme Name correctly applied !')

        Mobile.verifyMatch(SchemeDesc, findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        'Free Product1 datas'
        GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_Product1', Scheme_Index)
        ...
        Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

        Mobile.takeScreenshot()

        KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' : Free Product1 Case Qty correctly displayed !')

        Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_quantity', Scheme_Index))
        ...
        Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_quantity', Scheme_Index))
        ...
        'Free Product2 datas'
        GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_Product2', Scheme_Index)
        ...
        Mobile.verifyMatch(FreeSKU_Qty_Slab2, findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        Mobile.verifyMatch(Slab1_FreeSku2_PieceQty, findTestData('Mobile Input Data/6_OTP_SS_Free_Qty(In And Cond.)').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
