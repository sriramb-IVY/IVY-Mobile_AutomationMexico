...
String sheet_name = '8_OTP_SS_AND_Cond(In_Any_Cond)'
...
//
//Mobile.callTestCase(findTestCase('VBL_Mobile/Scheme/Reusable Cases/ANY_Condition_Free_Sku_Validation'), [('Scheme_Free_SKU') : findTestData('Mobile Input Data/Combination_Scheme').getValue('Get01_FP_01', Scheme_Index), ('Scheme_Free_SKU02') : findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct02_Slab1', Scheme_Index), ('FreeSKU_MinQty') : findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index)
//	, ('FreeSKU_MaxQty') : findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Case_Slab1_MAX', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
//
...
WebUI.callTestCase(findTestCase('Product_Mobile/Regression_Schemes/Call Test Cases/RE_SCH_008_CT_1'), [:], FailureHandling.STOP_ON_FAILURE)
