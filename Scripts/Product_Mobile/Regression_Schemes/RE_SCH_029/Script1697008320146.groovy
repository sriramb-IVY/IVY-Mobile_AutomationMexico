...
String sheet_name = '13_B8_MTR_FP_Slab_1_Value'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    if ((Quantity_variations.get(i) == 'Slab1') || (Quantity_variations.get(i) == 'Double_Slab1')) {
        'Positive flow Scheme Validation for single slab and double quantity'
        Mobile.tap(findTestObject('Mobile/Common/Icon_Search'), 4, FailureHandling.OPTIONAL)

        'BUY SKU_1'
        GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Buy_Product', Scheme_Index)
        ...
        Tot_value = findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Sales_Value', Scheme_Index)
        ...
        Mobile.verifyMatch(SchemeName, findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        Mobile.verifyMatch(SchemeDesc, findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Free_Product', Scheme_Index)
        ...
        Mobile.verifyMatch(FreeSKU_Qty_Slab, findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

        Mobile.takeScreenshot()

        KeywordUtil.logInfo(FreeSKU_Qty_Slab + ' : Free Product Piece Qty correctly displayed !')

        Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Free_quantity', Scheme_Index))
        ...
        Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Free_quantity', Scheme_Index))
        ...
        Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('Batch_Scheme_Inputs_01/13_B8_MTR_FP_Slab_1_Value').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        WebUI.callTestCase(findTestCase('Product_Mobile/Common/OrderPopUp(EditOrder)'), [:], FailureHandling.STOP_ON_FAILURE //slab_1
            //GlobalVariable.ProductName = Buy_Product_1.get(i)
            )
