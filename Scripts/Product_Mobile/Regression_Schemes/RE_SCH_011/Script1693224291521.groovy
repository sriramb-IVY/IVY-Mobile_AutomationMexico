...
String sheet_name = '11_B4_DV_OTP_Slabs_2_SubBrand'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input Data/11_B4_DV_OTP_Slabs_2_SubBrand').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
	...
	if ((Quantity_variations.get(i) == 'First slab') || (Quantity_variations.get(i) == 'Second slab')) {
		...
		//slab_1
		'Slab_1'
		GlobalVariable.ProductName = findTestData('Mobile Input Data/11_B4_DV_OTP_Slabs_2_SubBrand').getValue('SKU_Name', Scheme_Index)
		...
		Tot_value = findTestData('Mobile Input Data/11_B4_DV_OTP_Slabs_2_SubBrand').getValue('Sales_Value', Scheme_Index)
		...
		Mobile.verifyMatch(SchemeName, findTestData('Mobile Input Data/11_B4_DV_OTP_Slabs_2_SubBrand').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

		Mobile.takeScreenshot()

		KeywordUtil.logInfo(SchemeName + ' :Scheme Name correctly applied !')

		Mobile.verifyMatch(SchemeDesc, findTestData('Mobile Input Data/11_B4_DV_OTP_Slabs_2_SubBrand').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

		Mobile.takeScreenshot()

		KeywordUtil.logInfo(SchemeDesc + ' :Scheme Description correctly displayed !')

		Discount_Perc_Sheet = findTestData('Mobile Input Data/11_B4_DV_OTP_Slabs_2_SubBrand').getValue('Discount_percentage', Scheme_Index)
		...
		// Mobile.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Generate_OrderInvoice'), [:], FailureHandling.STOP_ON_FAILURE) //        Mobile.tap(findTestObject('Mobile/SummaryScreen/SummaryScreen-Order btn'), 3)
		...
		int Quantity = (Sales_Value / Piece_Price) - 5
