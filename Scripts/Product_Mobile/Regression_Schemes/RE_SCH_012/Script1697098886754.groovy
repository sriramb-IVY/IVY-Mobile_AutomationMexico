...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.ProductName = findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Buy_Product01', Scheme_Index)
...
Slab = findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Buy_Product_Piece_Qty', Scheme_Index)
...
'Buy_Product02'
GlobalVariable.ProductName = findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Buy_Product02', Scheme_Index)
...
Mobile.verifyMatch(SchemeName, findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(SchemeDesc, findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Get_Product01', Scheme_Index)
...
Expecetd_FreeSKU_MinQty_Slab = ('Min:' + findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Free_quantity', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab = ('Max:' + findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Free_quantity', Scheme_Index))
...
GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Get_Product02', Scheme_Index)
...
if (Integer.parseInt(FreeSKU_1_Qty_Slab) != 0) {
    ...
    Mobile.verifyMatch(FreeSKU_1_Qty_Slab, findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
    ...
    Mobile.verifyMatch(FreeSKU_2_Qty_Slab, findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.Qty = findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Free_quantity', Scheme_Index)

Mobile.verifyMatch(Slab_FreeSku_PieceQty, findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Slab_Qty = findTestData('Mobile Input data/12_B4_FP_OTP_Slab_1_App').getValue('Free_quantity', Scheme_Index)
...
WebUI.callTestCase(findTestCase('Product_Mobile/Regression_Schemes/Call Test Cases/RE_SCH_012_CT_1'), [:], FailureHandling.STOP_ON_FAILURE)
