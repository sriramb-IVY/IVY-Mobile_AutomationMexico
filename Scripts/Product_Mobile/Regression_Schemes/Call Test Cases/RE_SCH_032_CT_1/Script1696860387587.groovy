...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
'Buy_SKU_1'
GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Buy_Group1_P1', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('BG1_Piece_quantity', Scheme_Index)
...
'Buy_SKU_2'
GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Buy_Group2_P1', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('BG2_Piece_quantity', Scheme_Index)
...
'Buy_SKU_3'
GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Buy_Group2_P2', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('BG3_Piece_quantity', Scheme_Index)
...
'total value calculation for all product2'
Total_2 = (Double.parseDouble(GlobalVariable.Qty) * Piece_Price)
...
Mobile.verifyMatch(SchemeName, findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(SchemeDesc, findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Free_Product', Scheme_Index)
...
Mobile.verifyMatch(FreeSKU_Qty_Slab, findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_Qty_Slab + ' : Free Product Piece Qty correctly displayed !')

Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Free_quantity', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Free_quantity', Scheme_Index))
...
Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('Batch_Scheme_Inputs_01/16_B9_MTR_FP_MS_AD_Disc').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
