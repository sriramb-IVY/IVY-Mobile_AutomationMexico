...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
'Buy_SKU_1'
GlobalVariable.ProductName = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Buy_Group1_P1', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('BG1_Piece_quantity', Scheme_Index)
...
'Buy_SKU_2'
GlobalVariable.ProductName = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Buy_Group1_P2', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('BG2_Piece_quantity', Scheme_Index)
...
'Buy_SKU_3'
GlobalVariable.ProductName = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Buy_Group1_P3', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('BG3_Piece_quantity', Scheme_Index)
...
Mobile.verifyMatch(SchemeName, findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(SchemeDesc, findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Free_Product', Scheme_Index)
...
Mobile.verifyMatch(FreeSKU_Qty_Slab, findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_Qty_Slab + ' : Free Product Piece Qty correctly displayed !')

Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Free_quantity', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Free_quantity', Scheme_Index))
...
Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Free_quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
