...
//if (Quantity_variations.get(i) == 'Less than First Slab') {
...
Slab_1_Min_Qty = findTestData('Mobile Input Data/14_B5_OTP_FP_ADDISC_MS').getValue('Min_quantity', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Mobile Input Data/14_B5_OTP_FP_ADDISC_MS').getValue('Max_quantity', Scheme_Index)
...
Slab_1_Min_Qty = findTestData('Mobile Input Data/14_B5_OTP_FP_ADDISC_MS').getValue('Mid_quantity', Scheme_Index)
