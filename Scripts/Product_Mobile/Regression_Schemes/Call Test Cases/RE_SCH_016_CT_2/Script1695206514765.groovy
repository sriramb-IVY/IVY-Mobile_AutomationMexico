...
not_run: Mobile.tap(findTestObject('Mobile/Common/Icon_Back'), 1, FailureHandling.OPTIONAL)
...
Min_Qty_1 = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('BG1_Piece_quantity', Scheme_Index)
...
Min_Qty_2 = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('BG2_Piece_quantity', Scheme_Index)
...
Min_Qty_3 = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('BG3_Piece_quantity', Scheme_Index)
...
add_disc = findTestData('Mobile Input Data/16_B5_OTP_FP_A_D_Slabs_2').getValue('Additional_discount', Scheme_Index)
