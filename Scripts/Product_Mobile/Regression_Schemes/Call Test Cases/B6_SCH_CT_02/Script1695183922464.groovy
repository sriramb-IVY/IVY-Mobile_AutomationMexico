...
//WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Batch_Scheme_Inputs_01/4_B6_MTS_DP_S1(QTY)').getValue(
...
Mobile.verifyMatch(Slab_FreeSku_PieceQty, findTestData('Batch_Scheme_Inputs_01/5_B6(Appor)_MS_FP(QTY)_MTS').getValue('Get_Product_S2_Piece_Qty', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Slab_Qty = findTestData('Batch_Scheme_Inputs_01/5_B6(Appor)_MS_FP(QTY)_MTS').getValue('Get_Product_S2_Piece_Qty', Scheme_Index)
