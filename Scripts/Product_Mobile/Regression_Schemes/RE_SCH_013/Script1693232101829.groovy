...
String sheet_name = '13_B4_DV_OTP_Slabs_2_Brand'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input Data/13_B4_DV_OTP_Slabs_2_Brand').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    if ((Quantity_variations.get(i) == 'First slab') || (Quantity_variations.get(i) == 'Second slab')) {
        ...
        //slab_1
        'Slab_1'
        GlobalVariable.ProductName = findTestData('Mobile Input Data/13_B4_DV_OTP_Slabs_2_Brand').getValue('SKU_Name', Scheme_Index)
        ...
        Slab_1_Min_Qty = findTestData('Mobile Input Data/13_B4_DV_OTP_Slabs_2_Brand').getValue('Piece_quantity', Scheme_Index)
        ...
        Mobile.verifyMatch(SchemeName, findTestData('Mobile Input Data/13_B4_DV_OTP_Slabs_2_Brand').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

        Mobile.takeScreenshot()

        KeywordUtil.logInfo(SchemeName + ' : Slab Scheme Name correctly applied !')

        Mobile.verifyMatch(SchemeDesc, findTestData('Mobile Input Data/13_B4_DV_OTP_Slabs_2_Brand').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

        Mobile.takeScreenshot()

        KeywordUtil.logInfo(SchemeDesc + ' : Slab Scheme Description correctly displayed !')

        Discount_value_Sheet = findTestData('Mobile Input Data/13_B4_DV_OTP_Slabs_2_Brand').getValue('Discount_Value', Scheme_Index)
        ...
        KeywordUtil.logInfo(Discountvalue + ' :Slab Discount percentage correctly applied !')
