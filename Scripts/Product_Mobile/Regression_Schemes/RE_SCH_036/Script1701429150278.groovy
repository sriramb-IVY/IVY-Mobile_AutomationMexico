...
String sheet_name = '17_B9_MTR_APRT_FP_Value'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Buy_Product', Scheme_Index)
    ...
    Tot_value = findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Sales_Value', Scheme_Index)
    ...
    if (((Quantity_variations.get(i) == 'Slab1') || (Quantity_variations.get(i) == 'Slab2')) || (Quantity_variations.get(i) == 'Double_Slab2')) {
        ...
        /*Mobile.verifyMatch(SchemeName, findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Scheme_Name',
        ...
        Mobile.verifyMatch(SchemeDesc, findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Free_Product', Scheme_Index)
        ...
        Expecetd_FreeSKU_MinQty_Slab = ('Min:' + findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Free_Get_Quantity', Scheme_Index))
        ...
        Expecetd_FreeSKU_MaxQty_Slab = ('Max:' + findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Free_Get_Quantity', Scheme_Index))
        ...
        Mobile.verifyMatch(FreeSKU_1_Qty_Slab, findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Free_Get_Quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        GlobalVariable.Qty = findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Free_Get_Quantity', Scheme_Index)

        Mobile.verifyMatch(Slab_FreeSku_PieceQty, findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Free_Get_Quantity', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        Slab_Qty = findTestData('Batch_Scheme_Inputs_01/17_B9_MTR_APRT_FP_Value').getValue('Free_Get_Quantity', Scheme_Index)
