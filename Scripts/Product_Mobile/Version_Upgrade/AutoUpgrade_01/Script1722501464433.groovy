...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/Mobile/Common/Popup_Title_EnableNetworkProvidedTime'), 10, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Object Repository/Mobile/Common/Btn_OK'), 1, FailureHandling.OPTIONAL)
...
if (Mobile.verifyElementVisible(findTestObject('Mobile/Login/Field_EnterActivationKey'), 15, FailureHandling.OPTIONAL)) {
...
Mobile.verifyElementVisible(findTestObject('Mobile/Auto_Upgrade/version_Upgrade'), 5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Mobile/Common/Btn_OK'), 10)
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Mobile/Auto_Upgrade/Install_Button'), 5, FailureHandling.STOP_ON_FAILURE)) {
    Mobile.tap(findTestObject('Mobile/Auto_Upgrade/Install_Button'), 10)

    Mobile.delay(30)

    Mobile.tap(findTestObject('Mobile/Auto_Upgrade/Button - Open'), 10)
}
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Mobile/Auto_Upgrade/App scan recommended'), 5, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Mobile/Auto_Upgrade/More details'), 10)

    Mobile.delay(2)

    Mobile.tap(findTestObject('Mobile/Auto_Upgrade/Install without scanning'), 10)
...
if (Mobile.verifyElementVisible(findTestObject('Mobile/Login/Field_EnterUsername'), 25, FailureHandling.OPTIONAL)) {
    Mobile.sendKeys(findTestObject('Mobile/Login/Field_EnterUsername'), GlobalVariable.VanSeller_UserName)
    ...
    if (Mobile.waitForElementPresent(findTestObject('Mobile/Common/Btn_Retry'), 25, FailureHandling.OPTIONAL)) {
...
Mobile.tap(findTestObject('Mobile/Common/Btn_Menu'), 35, FailureHandling.OPTIONAL)

Mobile.delay(2)

Mobile.waitForElementPresent(findTestObject('Mobile/Auto_Upgrade/Info_Icon'), 0, FailureHandling.OPTIONAL)

Mobile.tap(findTestObject('Mobile/Auto_Upgrade/Info_Icon'), 10)
...
if (Mobile.verifyElementNotExist(findTestObject('Mobile/Auto_Upgrade/Get_VersionNumber_InfoScreen'), 10, FailureHandling.OPTIONAL)) {
    ...
    Mobile.tap(findTestObject('Mobile/Auto_Upgrade/Info_Icon'), 10, FailureHandling.OPTIONAL)
}

Scrn_Version = Mobile.getText(findTestObject('Mobile/Auto_Upgrade/Get_VersionNumber_InfoScreen'), 0)
