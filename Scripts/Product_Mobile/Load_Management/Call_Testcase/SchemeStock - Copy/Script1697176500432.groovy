...
import static com.kms.katalon.core.testobject.ObjectRepository.findTestObject as Connection
...
ArrayList<String> SKU = CustomKeywords.'poi.Automation.GetAllWebDataRow_Flag.getAllDataRow'(file_name, sheet_name,
	'SKU')


ArrayList<String> s = new LinkedHashSet<String>(SKU);
...
//	//String str = SKU.get(i).getText()
//	tableValues.add(SKU.get(i));
//}
//
...
//
//	println(referenceValues.add(tableValues.get(i)))
//	}
//
//fin = Collections.sort(SKU)
//
//println(tableValues)
//
