...
Mobile.takeScreenshot()
//Exist_plan = Mobile.getText(findTestObject('Mobile/Deviation/Text_Retailer is already planned for today'), 
//    3)
//
//KeywordUtil.logInfo('Exist_plan  = ' + Exist_plan)
...
KeywordUtil.logInfo('Without Choosing Task')
...
Mobile.callTestCase(findTestCase('Product_Mobile/DB/Invoice_Delete_DB'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Product_Mobile/DB/Order_Delete_DB'), [:], FailureHandling.STOP_ON_FAILURE)
