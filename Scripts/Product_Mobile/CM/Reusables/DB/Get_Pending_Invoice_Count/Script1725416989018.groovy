...
queryString = (('select * from AppData_Pending_Bills where PB_ARTR_Id = \'' + GlobalVariable.label) + '\' and PB_Isactive = 1')
...
while (recordSet1.next()) {
	String PB_Isactive = recordSet1.getObject('PB_Isactive')

	 count = Bill_Count++
	 
	 KeywordUtil.logInfo(count.toString())

	 GlobalVariable.label1 = count 

	}

KeywordUtil.logInfo(GlobalVariable.label1.toString() )