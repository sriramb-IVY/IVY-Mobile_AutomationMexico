...
if (recordSet1.next()) {
	String Credit_Balance = recordSet1.getObject('AROD_Credit_Balance')
	
	GlobalVariable.Credit_Balance = Credit_Balance
	
	KeywordUtil.logInfo(Credit_Balance + ' : After increased value credit balance')
}
