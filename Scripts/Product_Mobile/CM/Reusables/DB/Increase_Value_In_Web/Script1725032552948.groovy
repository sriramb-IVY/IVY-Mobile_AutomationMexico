...
//for (j = 0; j < Retailer_Name.size(); j++) {
   // KeywordUtil.logInfo(Retailer_Name.get(j) + ' ::: Retailer Name displayed in loop')
    ...
    Credit_Limit = findTestData('Mobile Input Data/CreditManagement').getValue('Increase_Value', i)
    ...
    Warn_Credit_Limit = findTestData('Mobile Input Data/CreditManagement').getValue('Increase_Value', i)
    ...
    Credit_Period = findTestData('Mobile Input Data/CreditManagement').getValue('Increase_Value', i)
    ...
    Warn_Credit_Period = findTestData('Mobile Input Data/CreditManagement').getValue('Increase_Value', i)
    ...
    Credit_Bill = findTestData('Mobile Input Data/CreditManagement').getValue('Increase_Value', i)
    ...
    Warn_Credit_Bill = findTestData('Mobile Input Data/CreditManagement').getValue('Increase_Value', i)
...
//	
//	queryString = (('select * from adm_retailer where ARTR_Code = \'' + Retailer_Name.get(j)) + '\' and ARTR_Isactive = 1')
//	
