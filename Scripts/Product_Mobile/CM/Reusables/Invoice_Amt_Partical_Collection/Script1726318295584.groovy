...
'The user can view the list of Pending Invoices details'

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Mobile/Collection/Values/Tap_On_Last_Invoice'), 0)
...
Mobile.setText(findTestObject('Mobile/Collection/Cash/Amount'), '1', 0, FailureHandling.STOP_ON_FAILURE)
