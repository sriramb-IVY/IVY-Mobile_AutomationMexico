...
CustomKeywords.'credit_management.Fetch_query_1.LIMITS_overdue'(findTestData('Data Files/Mobile Input Data/update_credit_warn_1').getValue(
	'SID_Retailer', 10), findTestData('Data Files/Mobile Input Data/update_credit_warn_1').getValue('Balance', 10), findTestData(
	'Data Files/Mobile Input Data/update_credit_warn').getValue('overdue', 10))

CustomKeywords.'credit_management.Fetch_query_1.delete_invoice'(findTestData('Data Files/Mobile Input Data/update_credit_warn_1').getValue('SID_Retailer',10))

'soft alert increase'
String sheet_name = 'Ch_Period_Increase'
...
//	Product1 = findTestData('Mobile Input Data/Ch_Period_Increase').getValue('Product', 1)
//	Qty = findTestData('Mobile Input Data/Ch_Period_Increase').getValue('CaseQty', 1)
//	
...
//	
    ...
    if (Retailer_Level.get(i) == 'Above the limit – soft alert') {
    ...
    if ((Retailer_Level.get(i) == 'Below the limit') || (Retailer_Level.get(i) == 'After soft alert increase the limit') ) {
        Mobile.delay(5)
		...
		if ((Retailer_Level.get(i) == 'Below the limit')) {
			...
			Code = findTestData('Mobile Input Data/Ch_Period_Increase').getValue('Retailer', 1)
...
Retailer1 = findTestData('Mobile Input Data/Ch_Period_Increase').getValue('Retailer', 1)
