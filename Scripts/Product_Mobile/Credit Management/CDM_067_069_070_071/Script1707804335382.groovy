...
String sheet_name = 'Credit_Management'

String file_name = 'Mobile Input data'

ArrayList<String> Credit_limit_retailer = CustomKeywords.'poi.Automation.GetAllDataRow_Flag.getAllDataRow'(file_name, sheet_name, 
    'Credit_limit_retailer')

ArrayList<String> Credit_Validation = CustomKeywords.'poi.Automation.GetAllDataRow_Flag.getAllDataRow'(file_name, sheet_name, 
    'Credit_Validation')

for (int i = 0; i < Credit_limit_retailer.size(); i++) {
    Scheme_Index = (i + 1)
    ...
    if (i == 2) {
        ...
        Mobile.verifyMatch(Warning_message_popup, findTestData('Mobile Input Data/Limit-Bill_Combination').getValue('Limit_Alert_Popup', 
                Scheme_Index), false)
        ...
        Mobile.verifyMatch(limit_exceed_alert_popup, findTestData('Mobile Input Data/Limit-Bill_Combination').getValue('Bill_Alert_Popup', 
                Scheme_Index), false)
