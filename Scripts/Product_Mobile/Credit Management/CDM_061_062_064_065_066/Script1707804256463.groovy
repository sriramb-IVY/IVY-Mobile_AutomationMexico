...
for (int i = 0; i < Channelwise_Retailer.size(); i++) {
	...
	//slab_1
	'Slab_1'
	GlobalVariable.ProductName = findTestData('Mobile Input Data/Bill_Validations').getValue('Product_Name', Scheme_Index)
	...
	Slab_1_Min_Qty = findTestData('Mobile Input Data/Bill_Validations').getValue('Piece_quantity', Scheme_Index)
	...
	if ((i == 0) || (i == 1) || (i == 2) || (i == 4) || (i == 5)) {
		...
		Mobile.verifyMatch(Warning_message_popup, findTestData('Mobile Input Data/Bill_Validations').getValue('Alert_Popup', Scheme_Index), false)
		...
		Mobile.verifyMatch(limit_exceed_alert_popup, findTestData('Mobile Input Data/Bill_Validations').getValue('Alert_Popup',
				Scheme_Index), false)
