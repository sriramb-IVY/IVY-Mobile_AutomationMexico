...
CustomKeywords.'credit_management.Fetch_query_1.LIMITS_overdue'(findTestData('Data Files/Mobile Input Data/update_credit_warn_1').getValue(
	'SID_Retailer', 8), findTestData('Data Files/Mobile Input Data/update_credit_warn_1').getValue('Balance', 8), findTestData(
	'Data Files/Mobile Input Data/update_credit_warn').getValue('overdue', 8))

CustomKeywords.'credit_management.Fetch_query_1.delete_invoice'(findTestData('Data Files/Mobile Input Data/update_credit_warn_1').getValue('SID_Retailer',8))
...
//	
	...
	Code = findTestData('Mobile Input Data/Period_Warn_Limit').getValue('Channel_Retailer', 1)
