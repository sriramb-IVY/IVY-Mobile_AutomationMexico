...
Mobile.callTestCase(findTestCase('Test Cases/Product_Mobile/Common/Web Login and Navigation/Navigate to Indicative Empty Collection'), [:], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.label = findTestData('Web Input Data/Empties').getValue('SalesPerson', 1)
