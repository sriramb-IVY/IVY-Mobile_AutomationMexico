...
//WebUI.navigateToUrl('https://qa-automation.ivycpg.com/web/DMS')
WebUI.waitForElementVisible(findTestObject('Web Part/Re-usable/Login/Username'), 5)

WebUI.setText(findTestObject('Web Part/Re-usable/Login/Username'), GlobalVariable.DivisionUsername)

WebUI.setText(findTestObject('Web Part/Re-usable/Login/Password'), GlobalVariable.DivisionPassword)
