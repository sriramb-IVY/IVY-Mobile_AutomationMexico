...
if (Mobile.verifyElementVisible(findTestObject('Mobile/Common/Btn_OK'), 2, FailureHandling.OPTIONAL)) {
...
'Click Start Vist button and go to the Store Activities Screen'
Mobile.tap(findTestObject('Mobile/Common/Btn_StartVisit'), 0)

if (Mobile.verifyElementVisible(findTestObject('Mobile/Common/Popup_Title_LocationValidation'), 2, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Mobile/Common/Btn_YES'), 5)
}

Mobile.swipe(50, 50, 50, 650)
