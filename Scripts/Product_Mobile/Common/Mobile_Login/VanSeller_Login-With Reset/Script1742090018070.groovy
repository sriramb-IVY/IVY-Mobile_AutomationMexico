...
import com.kms.katalon.core.mobile.keyword.builtin.SwipeKeyword as SwipeKeyword
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/Start_Trip_CT'), [:], FailureHandling.STOP_ON_FAILURE)
