...
'Accept the Vanload stock for vanseller'
WebUI.callTestCase(findTestCase('Product_Mobile/Common/Seller_Menu_Selection'), [('MenuName') : findTestData('Mobile Input Data/Common').getValue(
            'Menu', 18), ('SubMenuName') : findTestData('Mobile Input Data/Common').getValue('Menu', 21)], FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Mobile/Common/Btn_YES'), 1, FailureHandling.OPTIONAL)
