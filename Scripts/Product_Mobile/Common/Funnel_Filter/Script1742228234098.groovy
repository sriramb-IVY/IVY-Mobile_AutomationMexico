...
if(Mobile.verifyElementVisible(findTestObject('Mobile/Common/Icon_FunnelFilter'), 1, FailureHandling.OPTIONAL))
{
...
GlobalVariable.label = Filter_Hierarchy

Mobile.tap(findTestObject('Mobile/Common/FilterScreen-MenuList(Global)'), 5)

GlobalVariable.label = Hierarchy_Value
