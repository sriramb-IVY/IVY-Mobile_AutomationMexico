...
WebUI.click(findTestObject('Mobile/Common_1/Date picker/Year_Option'))

WebUI.delay(1)

WebUI.click(findTestObject('Mobile/Common_1/Date picker/Month_Option'))

WebUI.delay(1)

WebUI.click(findTestObject('Mobile/Common_1/Date picker/Date'))
