...
String sheet_name = 'Empties_Scheme_MTS_FP_WO'
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Retailer', 1)], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i < Retailer.size(); i++) {
    ...
    'Buy_SKU_1'
    GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Salable_SKU_Name1', Scheme_Index)
    ...
    Slab_1_Min_Qty = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Buy_Quantity', Scheme_Index)
    ...
    GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Salable_SKU_Name2', Scheme_Index)
    ...
    Slab_1_Min_Qty_1 = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Buy_Quantity1', Scheme_Index)
    ...
    if ((((Quantity_variations.get(i) == 'Slab1') || (Quantity_variations.get(i) == 'Slab2')) || (Quantity_variations.get(i) == 'Slab1&2')) || (Quantity_variations.get(i) == 'Double of Slab2')) {
        ...
        GlobalVariable.label = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Empty_SKU_Name1', Scheme_Index)
        ...
        'Empty SKU 2'
        GlobalVariable.label = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Empty_SKU_Name2', Scheme_Index)
        ...
        if (((Quantity_variations.get(i) == 'Slab1') || (Quantity_variations.get(i) == 'Slab2')) || (Quantity_variations.get(i) == 'Double of Slab2')) {
            ...
            Freeproduct_qty = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Free_Product_Get_Qty1', Scheme_Index)
            ...
            Mobile.verifyMatch(SchemeName, findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Scheme_Name', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
            ...
            Mobile.verifyMatch(SchemeDesc, findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Slab_Description', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
            ...
            Freeproduct_qty1 = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Free_Product_Get_Qty1', Scheme_Index)

            Freeproduct_qty2 = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Free_Product_Get_Qty_Slab2', Scheme_Index)
            ...
            'Slab Description Verification'
            Mobile.verifyMatch(SchemeDesc, findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Slab_Description_MTS', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
        ...
        GlobalVariable.Scheme_Free_SKU = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Empty_SKU_Name1', Scheme_Index)

        Mobile.verifyElementVisible(findTestObject('Mobile/SummaryScreen/Summary_FreeSkuTitle(Global)'), 5)

        GlobalVariable.ProductName = findTestData('Batch_Scheme_Inputs_01/Empties_Scheme_MTS_FP_WO').getValue('Empty_SKU_Name1', Scheme_Index)
