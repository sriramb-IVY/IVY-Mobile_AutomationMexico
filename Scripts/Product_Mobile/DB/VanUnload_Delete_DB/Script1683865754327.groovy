...
queryString = (('select top 3 * from AppData_Van_UnLoad_header where vuh_auh_id=\'' + GlobalVariable.vanseller_user_id + '\' and vuh_av_id=\'' + GlobalVariable.van_id + '\'and vuh_date=\'' + DB_Currentdate) + '\'')
...
while (recordSet.next()) {
	String data1 = recordSet.getObject('VUH_Id')

	KeywordUtil.logInfo(data1)

	GlobalVariable.label = data1
	
	String data2 = recordSet.getObject('vuh_date')
	
	println(data2)


queryString01 = (('delete from AppData_Van_UnLoad_Detail where vud_vuh_id=\'' + GlobalVariable.label) + '\'')
...
queryString0 = (('delete from AppData_Van_UnLoad_header where vuh_auh_id= \'' + GlobalVariable.vanseller_user_id + '\' and vuh_av_id= \'' + GlobalVariable.van_id + '\'and VUH_Id=\'' + GlobalVariable.label) + '\'')
