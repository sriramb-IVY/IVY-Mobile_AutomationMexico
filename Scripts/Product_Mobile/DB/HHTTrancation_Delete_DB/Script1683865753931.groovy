...
queryString = ((('delete from HHTTransactionDataQueueList_Details where CONVERT(varchar, CreatedDate, 23) like \'' + GlobalVariable.First_Date) + '\' and UserId = \'' + GlobalVariable.vanseller_user_id) + '\'')
...
'Execute Query 02'
queryString = ((('delete from hhttransactiondataqueuelist where CONVERT(varchar, CreatedDate, 23) like \'' + GlobalVariable.First_Date) + '\' and UserId = \'' + GlobalVariable.vanseller_user_id) + '\'')
