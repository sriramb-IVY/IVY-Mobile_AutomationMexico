...
//queryString = (('select * from appdata_order_header where OH_User_Id = \'' + GlobalVariable.vanseller_user_id + '\' and OH_Date=\'' + DB_Currentdate) + '\'')
//
...
queryString01 = ('delete from appdata_order_detail where OD_Created_By = \'' + GlobalVariable.vanseller_user_id + '\'')
...
queryString0 = (('delete from appdata_order_scheme_detail where OSD_Created_By= \'' + GlobalVariable.vanseller_user_id) + '\'')
...
queryString1 = ('delete from appdata_order_tax_detail where  OTD_Created_By = \'' + GlobalVariable.vanseller_user_id + '\'')
...
//queryString2 = (('delete from appdata_order_discount_detail where odd_oh_id= \'' + GlobalVariable.label) + '\'')
//
...
queryString3 = ('delete from appdata_order_header where OH_User_Id = \'' + GlobalVariable.vanseller_user_id + '\'')
...
//queryString4 = (('delete from AppData_Order_Scheme_Detail_Credit where osdc_oh_id= \'' + GlobalVariable.label) + '\'')
