...
queryString = (('delete from AppData_Attendance_Time_Detail where aatd_su_id=\'' + GlobalVariable.vanseller_user_id) + '\'')
...
queryString = (('delete from AppData_Attendance_Detail where aad_su_id=\'' + GlobalVariable.vanseller_user_id) + '\' ')
