...
GlobalVariable.input = findTestData('Web Input Data/Task_Management').getValue('Title_Name', 1)
...
if (recordSet.next()) {
    ...
    WebUI.verifyEqual(AT_Code, findTestData('Web Input Data/Task_Management').getValue('Title_Name', 1), FailureHandling.STOP_ON_FAILURE)

    AT_Description = recordSet.getObject('AT_Description')

    WebUI.verifyEqual(AT_Description, findTestData('Web Input Data/Task_Management').getValue('Title_Description', 1), FailureHandling.STOP_ON_FAILURE)
} else {
...
if (recordSet2.next()) {
    ...
    Mobile.verifyMatch(data1, findTestData('Web Input Data/Task_Management').getValue('Retailer', 1), false, FailureHandling.STOP_ON_FAILURE)
} else {
    'If data is empty in the DB, then the flow must fail'
    Assert.fail()
}
...
'MobileRoutineTask'
GlobalVariable.input = findTestData('Web Input Data/Task_Management').getValue('Title_Name', 2)
...
if (recordSet.next()) {
    ...
    WebUI.verifyEqual(AT_Code, findTestData('Web Input Data/Task_Management').getValue('Title_Name', 2), FailureHandling.STOP_ON_FAILURE)

    AT_Description = recordSet.getObject('AT_Description')

    WebUI.verifyEqual(AT_Description, findTestData('Web Input Data/Task_Management').getValue('Title_Description', 2), FailureHandling.STOP_ON_FAILURE)
} else {
    'If data is empty in the DB, then the flow must fail'
    Assert.fail()
}
...
if (recordSet2.next()) {
    ...
    Mobile.verifyMatch(data1, findTestData('Web Input Data/Task_Management').getValue('Retailer', 2), false, FailureHandling.STOP_ON_FAILURE)
} else {
    'If data is empty in the DB, then the flow must fail'
    Assert.fail()
}
