...
//
//    WebUI.verifyMatch(scheme_Mapped_Location.substring(0, 9), Expected_location, false)
//
...
Mobile.verifyMatch(SchemeName.replaceAll('\\s', ''), findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('SchemeName', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
