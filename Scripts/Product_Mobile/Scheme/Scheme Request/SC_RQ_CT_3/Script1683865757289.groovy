...
GlobalVariable.mapping = findTestData('Web Input Data/Scheme_Retailer_Master').getValue('Category_name', 1)

GlobalVariable.label = GlobalVariable.mapping

WebUI.scrollToElement(findTestObject('Object Repository/Web Part/Re-usable/Global/td_Tag(GridSkuRow)'), 2, 
    FailureHandling.OPTIONAL)

Scheme_mapped_category_name = WebUI.getText(findTestObject('Object Repository/Web Part/Re-usable/Global/td_Tag(GridSkuRow)'))

KeywordUtil.logInfo(Scheme_mapped_category_name)

WebUI.verifyMatch(Scheme_mapped_category_name, GlobalVariable.Category_name, false, FailureHandling.STOP_ON_FAILURE)
