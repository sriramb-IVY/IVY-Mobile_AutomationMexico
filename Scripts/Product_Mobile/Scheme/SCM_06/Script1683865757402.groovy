...
//
//    String Expected_location = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Location_name_mapping', a + 1)
//
//    String Expected_retailer = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Retailer_mapping', a + 1)
//
