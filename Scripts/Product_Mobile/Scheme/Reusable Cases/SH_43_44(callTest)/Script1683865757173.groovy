...
for (int i = 0; i < SchemeName.size(); i++) {
    ...
    WebUI.waitForElementNotVisible(findTestObject('Web Part/Re-usable/Page Load'), 100) //	exlpath = 'DDF\\Mobile Input data\\Mobile Input data.xlsx'
    

    WebUI.waitForElementVisible(findTestObject('Web Part/Scheme/Next_Btn_SchemeTab'), 0)

    WebUI.click(findTestObject('Web Part/Scheme/Next_Btn_SchemeTab'))

    WebUI.waitForElementNotVisible(findTestObject('Web Part/Re-usable/Page Load'), 100 //	exlpath = 'DDF\\Mobile Input data\\Mobile Input data.xlsx'
        )

    WebUI.waitForElementVisible(findTestObject('Web Part/Scheme/Next_Btn_PromotionGroupTab'), 0)

    WebUI.click(findTestObject('Web Part/Scheme/Next_Btn_PromotionGroupTab'))

    WebUI.waitForElementNotVisible(findTestObject('Web Part/Re-usable/Page Load'), 100 //	exlpath = 'DDF\\Mobile Input data\\Mobile Input data.xlsx'
        )

    WebUI.waitForElementVisible(findTestObject('Web Part/Scheme/Next_Btn_PromotionSlabTab'), 0)

    WebUI.click(findTestObject('Web Part/Scheme/Next_Btn_PromotionSlabTab'))

    WebUI.waitForElementNotVisible(findTestObject('Web Part/Re-usable/Page Load'), 100 //	exlpath = 'DDF\\Mobile Input data\\Mobile Input data.xlsx'
        )

    WebUI.waitForElementVisible(findTestObject('Web Part/Scheme/View_Icon_CriteriaMappingTab'), 0)

    WebUI.click(findTestObject('Web Part/Scheme/View_Icon_CriteriaMappingTab'))

    WebUI.waitForElementVisible(findTestObject('Web Part/Scheme/MappedRetailerAttribute_1row'), 0)

    MappedRetailerAttribute_Name = WebUI.getText(findTestObject('Web Part/Scheme/MappedRetailerAttribute_1row'))

	
    WebUI.click(findTestObject('Web Part/Scheme/X_btn_CriteriaMappingScreen'))

    WebUI.delay(1)

    WebUI.click(findTestObject('Web Part/Scheme/Return_Btn_CriteriaMappingTab'))
