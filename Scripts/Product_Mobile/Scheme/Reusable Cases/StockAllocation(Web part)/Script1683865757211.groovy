...
for (int i = 0; i < Warehouse.size(); i++) {
    if (Warehouse.get(i) != 'NULL') {
        ...
        for (j = 0; j < SKU_Name.size(); j++) {
            ...
            WebUI.verifyElementVisible(findTestObject('Web Part/Stock Allocation/Filter/Filter_Icon'), FailureHandling.OPTIONAL)

            WebUI.click(findTestObject('Web Part/Stock Allocation/Filter/Filter_Icon'), FailureHandling.OPTIONAL)

            WebUI.click(findTestObject('Web Part/Stock Allocation/Filter/Sku_Name'), FailureHandling.OPTIONAL)

            WebUI.clearText(findTestObject('Web Part/Stock Allocation/Filter/Sku_Name'), FailureHandling.OPTIONAL)

            WebUI.setText(findTestObject('Web Part/Stock Allocation/Filter/Sku_Name'), GlobalVariable.ProductName, FailureHandling.OPTIONAL)

            WebUI.click(findTestObject('Web Part/Stock Allocation/Filter/Appy_Btn'), FailureHandling.OPTIONAL)

            WebUI.verifyElementPresent(findTestObject('Web Part/Stock Allocation/Global Variables/EnterCaseValue_Td Tag'), 5, FailureHandling.OPTIONAL)

            GlobalVariable.CaseQty = case_Quantity.get(j)

            WebUI.sendKeys(findTestObject('Web Part/Stock Allocation/Global Variables/EnterCaseValue_Td Tag'), GlobalVariable.CaseQty, FailureHandling.OPTIONAL)

            WebUI.waitForElementNotVisible(findTestObject('Web Part/Re-usable/Page Load'), 50, FailureHandling.OPTIONAL //            GlobalVariable.PieceQty = Piece_Quantity.get(j)
                ) //
