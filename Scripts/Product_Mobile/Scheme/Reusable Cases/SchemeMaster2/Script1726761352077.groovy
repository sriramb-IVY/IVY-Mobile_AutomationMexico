...
ArrayList<String> SchemeName = CustomKeywords.'poi.Automation.GetAllDataRow_Flag.getAllDataRow'(file_name, sheet_name, 'SchemeName')
...
for (int i = 0; i < SchemeName.size(); i++) {
    ...
    WebUI.scrollToElement(findTestObject('XXXXXXXXXXXX/Web Part/Scheme/SchemeApplyType'), 100)

    WebUI.waitForElementVisible(findTestObject('XXXXXXXXXXXX/Web Part/Scheme/SchemeApplyType'), 100)

    SchemeApplyType = WebUI.getAttribute(findTestObject('XXXXXXXXXXXX/Web Part/Scheme/SchemeApplyType'), 'value')

    WebUI.click(findTestObject('XXXXXXXXXXXX/Web Part/Scheme/Return_Btn1'))
