...
Mobile.callTestCase(findTestCase('Product_Mobile/Common/DB'), [('Query') : 'select * from appdata_sales_invoice_scheme_detail where sisd_sih_id=\'' + GlobalVariable.label + '\'', ('columnNames') : ['SISD_AS_Id','SISD_APH_Id']], FailureHandling.STOP_ON_FAILURE)

String SISD_AS_Id = GlobalVariable.data[0]

GlobalVariable.label = SISD_AS_Id

String SISD_APH_Id = GlobalVariable.data[1]
...
//GlobalVariable.InvoiceNo = findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('OrderNumber', 2)
GlobalVariable.SO_Number = findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('OrderNumber', 4)
...
TotalAmt = findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('Total_Amt', 4)
...
SchemeAmt = findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('SchemeAmt', 4)
...
GrossAmt = findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('Gross_Amt', 4)

FreeProductAmt = findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('FreeProductAmt', 4)
...
GlobalVariable.ProductName = findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('FreeProduct', 4)
...
WebUI.verifyMatch(freeSkuQty, findTestData('Web Input Data/Sales_Order_Invoice_View').getValue('FreeProductQTY', 4), false, FailureHandling.STOP_ON_FAILURE)
