...
not_run: WebUI.callTestCase(findTestCase('Product_Mobile/Common/Web Login and Navigation/DivisionLogin'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Product_Mobile/Common/Web Login and Navigation/Navigate to Retailer Attribute'), [:], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.label = findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('Distributor', 1)

WebUI.setText(findTestObject('Web Part/RetailerAttribute/EnterDistributorFilterField'), GlobalVariable.label)

//WebUI.scrollToElement(findTestObject('Web Part/RetailerAttribute/Span and b_tag (distributor)'), 5, FailureHandling.OPTIONAL)
WebUI.delay(3)
...
GlobalVariable.label = findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('Channel_Name', 1)
...
for (int i = 0; i < Retailer.size(); i++) {
    if (Retailer.get(i) != 'null') {
        ...
        WebUI.scrollToElement(findTestObject('Web Part/RetailerAttribute/SchemeApplyType'), 100)

        SchemeApplyType1 = WebUI.getAttribute(findTestObject('Web Part/RetailerAttribute/SchemeApplyType'), 'value')
...
//        } else {
//            GlobalVariable.label1 = SchemeApplyType1.toUpperCase()
//        }
        
        WebUI.click(findTestObject('Web Part/RetailerAttribute/Cloase_Btn'))
        ...
        ExcelKeywords.setValueToCellByIndex(sheet1, i + 1, 2, GlobalVariable.label1)
