...
//    WebUI.refresh()
//
//    WebUI.callTestCase(findTestCase('Test Cases/Product_Mobile/Scheme/Retailer Master/RM_CT_05-Not Use'), [:], FailureHandling.STOP_ON_FAILURE)
//
//    WebUI.refresh()
//
//    WebUI.callTestCase(findTestCase('Test Cases/Product_Mobile/Scheme/Scheme Request/SC_RQ_CT_3'), [:], FailureHandling.STOP_ON_FAILURE)
//
...
//
//    WebUI.verifyNotMatch(scheme_mapped_retailer.substring(0, 9), expected_retailer, false)
//
//    WebUI.closeBrowser()
