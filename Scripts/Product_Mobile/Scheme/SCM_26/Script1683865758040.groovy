...
//	expected_Retailer_mapping = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Retailer_mapping',
//		a + 1)
//
//	expected_retailer_attribute = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue(
//		'Retailer_attribute_mapping', a + 1)
//
//	String scheme_Retailer_mapping = GlobalVariable.retailer_name
//
//	String scheme_Mapped_Retailer_Attribute = GlobalVariable.Retailer_Attribute
//
//	WebUI.verifyMatch(scheme_Retailer_mapping.substring(0, 17), expected_Retailer_mapping, false)
//
