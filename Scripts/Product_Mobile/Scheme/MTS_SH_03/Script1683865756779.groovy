...
DiscountPerc = Mobile.getText(findTestObject('Mobile/OrderInvoice/Scheme/DiscountPerc_2'), 0)
...
Discount_Perc_Sheet1 = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('DiscountPercSlab1', Scheme_Index)

Discount_Perc_Sheet2 = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('DiscountPercSlab2', Scheme_Index)

Discount_Perc_Sheet = (Double.parseDouble(Discount_Perc_Sheet1) + Double.parseDouble(Discount_Perc_Sheet2))

Calculated_Sch_Amt = ((Total * Discount_Perc_Sheet) / 100)
