...
//
//	WebUI.verifyNotMatch(scheme_Mapped_Location.substring(0, 6), Expected_location, false)
//
//	// WebUI.verifyMatch(scheme_mapped_retailer_attribute.substring(0, 9), expected_retailer_attribute, false)
//
//	WebUI.verifyNotMatch(scheme_mapped_channel.substring(0, 12), Expected_channel, false)
//
//	WebUI.closeBrowser()
