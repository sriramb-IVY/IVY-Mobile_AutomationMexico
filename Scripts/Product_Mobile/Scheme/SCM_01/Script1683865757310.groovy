...
//
//    expected_Channel_name = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Channel_name_mapping', a + 1)
//
...
//
//    WebUI.verifyMatch(scheme_mapped_channel.substring(0, 13), expected_Channel_name, false)
//
//    WebUI.closeBrowser()
//
