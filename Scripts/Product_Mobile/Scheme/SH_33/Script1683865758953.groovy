...
for (int i = 0; i < Retailer.size(); i++) {
    if (Retailer.get(i) != 'null') {
        ...
        if ((RetailerApplyType == GlobalVariable.Variable) || (RetailerApplyType == GlobalVariable.Fixed_DD)) {
            ...
            CheckBox = Mobile.getAttribute(findTestObject('Mobile/OrderInvoice/Scheme/Scheme_FreeProductQty_CheckBox'), 'checked', 1, FailureHandling.STOP_ON_FAILURE)
            ...
            GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Slab1', Scheme_Index)
            ...
            Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

            Mobile.takeScreenshot()

            KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')

            Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index))
            ...
            Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Case_Slab1_MAX', Scheme_Index))
            ...
            Slab1_FreeSku_Amt = Mobile.getText(findTestObject('Mobile/SummaryScreen/Summary_GetProductBasedTotalAmt(Global)'), 5)
            ...
            Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
