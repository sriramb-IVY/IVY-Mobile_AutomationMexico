...
String Slab_Qty = Integer.parseInt(Slab_1_Max_Qty)
...
String Slab_Qty2 = Integer.parseInt(Slab_1_Max_Qty)
...
Discount_value_Sheet = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('DiscounttValueSlab1', Scheme_Index)
