...
//
//    String Expected_channel = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Channel_name_mapping', 
//        a + 1)
//
//    String Expected_distributor = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Distributor_name_mapping', 
//        a + 1)
//
...
GlobalVariable.Qty = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('Slab_2_Min_Qty', Scheme_Index)
...
Slab_2_Min_Qty = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('Slab_2_Min_Qty', Scheme_Index)
