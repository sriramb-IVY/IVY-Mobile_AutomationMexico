...
//WebUI.callTestCase(findTestCase('VBL_Mobile/Re-Usables/Select_Retailer and Going_OrderInvoice_Screen'), [('RetailerName') : findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.ProductName = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('BuyProduct2', Scheme_Index)
...
'Free product 02'
GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct02_Slab1', Scheme_Index)
...
Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct02_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
String FreeSKU01_Qty = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', Scheme_Index)
...
String FreeSKU02_Qty = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct02_Case_Slab1', Scheme_Index)
