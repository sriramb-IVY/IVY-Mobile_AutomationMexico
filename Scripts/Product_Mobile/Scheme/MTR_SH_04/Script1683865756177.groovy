...
Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')

Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('FreeProduct_Case_Slab1_MAX', Scheme_Index))
...
Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
