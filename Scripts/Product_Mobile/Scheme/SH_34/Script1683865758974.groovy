...
for (int i = 0; i < Retailer.size(); i++) {
    if (Retailer.get(i) != 'null') {
        ...
        if ((RetailerApplyType == GlobalVariable.Variable) || (RetailerApplyType == GlobalVariable.Fixed_DD)) {
            ...
            Mobile.callTestCase(findTestCase('VBL_Mobile/Scheme/Reusable Cases/ANY_Condition_Free_Sku_Validation'), [('Scheme_Free_SKU') : findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Slab1', Scheme_Index), ('Scheme_Free_SKU02') : findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue(
                        'FreeProduct02_Slab1', Scheme_Index), ('FreeSKU_MinQty') : findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), ('FreeSKU_MaxQty') : findTestData('Mobile Input Data/Fixed_Variable_Scheme').getValue('FreeProduct_Case_Slab1_MAX', 
