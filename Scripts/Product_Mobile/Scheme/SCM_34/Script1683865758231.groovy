...
//	
//	WebUI.callTestCase(findTestCase('Test Cases/Product_Mobile/Scheme/Retailer Master/RM_CT_02'), [:], FailureHandling.STOP_ON_FAILURE)
//
//	WebUI.refresh()
//
//	
...
//	
//    expected_Location_name = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Location_name_mapping',
//        a + 1)
//
...
//
//
//    WebUI.verifyNotMatch(scheme_Mapped_Location.substring(0, 9), expected_Location_name, false)
//
//
//	WebUI.closeBrowser()
