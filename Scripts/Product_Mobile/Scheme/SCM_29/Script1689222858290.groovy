...
//    WebUI.refresh()
//
//    WebUI.callTestCase(findTestCase('Product_Mobile/Scheme/Scheme Request/SC_RQ_CT_4'), [:], FailureHandling.STOP_ON_FAILURE)
//
//    expected_Retailer = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Retailer_mapping', 
//        a + 1)
//
//    //	expected_Channel_name = findTestData('Data Files/Automation/Automation_Data/Scheme_CriteriaMapping').getValue('Channel_name_mapping',
//    //			a + 1)
//    //	expected_retailerattribute = findTestData('Data Files/Automation/Automation_Data/Scheme_CriteriaMapping').getValue('Retailer_mapping',
//    //		a + 1)
//    //	expected_Location_name = findTestData('Data Files/Automation/Automation_Data/Scheme_CriteriaMapping').getValue('Location_name_mapping',
//    //			a + 1)
...
//    //	String scheme_mapped_RetailerAttribute = GlobalVariable.Retailer_Attribute
//    //	WebUI.verifyNotMatch(scheme_Mapped_Location.substring(0, 6), expected_Location_name, false)
//    WebUI.verifyMatch(scheme_mapped_Retailer.substring(0, 9), expected_Retailer, false)
//
//    //	WebUI.verifyNotMatch(scheme_mapped_channel.substring(0, 13), expected_Channel_name, false)
//    //	WebUI.verifyMatch(scheme_mapped_RetailerAttribute.substring(0, 9), expected_retailerattribute, false)
//    //
//    WebUI.closeBrowser()
