...
Total = ((Double.parseDouble(Actual_CaseSize) * Double.parseDouble(Both_slab_Qty)) * Double.parseDouble(Actual_PiecePrice))

Mobile.verifyEqual(Double.parseDouble(SKU_TOTAL), Total, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(SKU_TOTAL + ' :Added Slab_1 and Slab_2 Sku Total Amount calculated and displayed correctly according the formula.')
