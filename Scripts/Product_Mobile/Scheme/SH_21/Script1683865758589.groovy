...
/// !_Sku
'ANY Logic'
GlobalVariable.ProductName = findTestData('Mobile Input Data/Automatio_Apportionate_Scheme').getValue('BuyProduct2', Scheme_Index)
...
//Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/Automatio_Apportionate_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index),
...
//KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')
//
Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/Automatio_Apportionate_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/Automatio_Apportionate_Scheme').getValue('FreeProduct02_Case_Slab1_MAX', Scheme_Index))
