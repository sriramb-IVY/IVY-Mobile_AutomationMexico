...
ExcelKeywords.setValueToCellByIndex(sheet1, 2, 2, GlobalVariable.Qty)
...
not_run: WebUI.callTestCase(findTestCase('Product_Mobile/Common/Generate_OrderInvoice and CloseCall'), [:], FailureHandling.STOP_ON_FAILURE)
...
ExcelKeywords.setValueToCellByIndex(sheet1, 2, 6, invoice_ID)
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/Sync'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Product_Mobile/Common/HHT_Transaction_DB'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Product_Mobile/Scheme/Reusable Cases/DB_Sales_Invoice_Precentage'), [:], FailureHandling.CONTINUE_ON_FAILURE)
