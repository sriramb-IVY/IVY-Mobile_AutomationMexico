...
//slab_1
'Adding Slab 1 max qty and Slab 2 max Qty'
...
Slab_1_Max_Qty = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('Slab_1_Max_Qty', Scheme_Index)

Slab_2_Max_Qty = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('Slab_2_Max_Qty', Scheme_Index)

String Both_slab_Qty = Integer.parseInt(Slab_1_Max_Qty) + Integer.parseInt(Slab_2_Max_Qty)

GlobalVariable.Qty = Both_slab_Qty

KeywordUtil.logInfo(GlobalVariable.Qty + '  : Adding Slab 1 and Slab 2 Qty')
...
Discount_Perc_Sheet = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('DiscountPercSlab2', Scheme_Index)
