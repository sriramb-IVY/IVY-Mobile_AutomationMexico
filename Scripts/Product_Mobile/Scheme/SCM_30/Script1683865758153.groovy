...
//        a + 1)
//
//    expected_Channel_name = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Channel_name_mapping', 
//        a + 1)
//
...
//
//    WebUI.verifyMatch(scheme_Mapped_Location.substring(0, 6), expected_Location_name, false)
//
//    WebUI.verifyMatch(scheme_mapped_channel.substring(0, 12), expected_Channel_name, false)
//
