...
//	
//	String expected_retailer_attribute= findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Retailer_attribute_mapping', a+1)
//
...
//
//	WebUI.verifyNotMatch(scheme_mapped_retailer_attribute.substring(0,9), expected_retailer_attribute, false)
//
//    WebUI.closeBrowser()
