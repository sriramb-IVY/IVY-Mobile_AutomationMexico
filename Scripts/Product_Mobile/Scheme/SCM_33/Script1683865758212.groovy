...
//    WebUI.refresh()
//
//    WebUI.callTestCase(findTestCase('Test Cases/Product_Mobile/Scheme/Retailer Master/RM_CT_04-Not Use'), [:], FailureHandling.STOP_ON_FAILURE)
//
//    WebUI.refresh()
//
//    WebUI.callTestCase(findTestCase('Test Cases/Product_Mobile/Scheme/Scheme Request/SC_RQ_CT_2'), [:], FailureHandling.STOP_ON_FAILURE)
//
//    //Data Files/Mobile Input Data/Scheme_CriteriaMapping
//    expected_Location_name = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Location_name_mapping', a + 1)
//
//    String scheme_Mapped_Location = GlobalVariable.location_name
//
//    WebUI.verifyMatch(scheme_Mapped_Location.substring(0, 9), expected_Location_name, false)
//
//    WebUI.closeBrowser()
...
Slab_1_Min_Qty = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('Slab_1_Max_Qty', Scheme_Index)
...
Mobile.verifyEqual(Double.parseDouble(SKU_TOTAL), Total1, FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.ProductName = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('BuyProduct2', Scheme_Index)
...
Mobile.verifyEqual(Double.parseDouble(SKU_TOTAL), Total2, FailureHandling.STOP_ON_FAILURE)
...
Discount_Perc_Sheet = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('DiscountPercSlab1', Scheme_Index)
...
GlobalVariable.Qty = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('Slab_2_Max_Qty', Scheme_Index)
...
Total1 = ((Double.parseDouble(Actual_CaseSize) * Double.parseDouble(GlobalVariable.Qty)) * Double.parseDouble(Actual_PiecePrice))

Mobile.verifyEqual(Double.parseDouble(SKU_TOTAL), Total1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(Total1.toString() + ' :Slab_2 Total Amount calculated and displayed correctly according the formula.')
...
Slab_2_Min_Qty = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('Slab_2_Max_Qty', Scheme_Index)

String Slab_Qty_2 = Integer.parseInt(Slab_2_Min_Qty)

GlobalVariable.Qty = Slab_Qty_2
...
Total2 = ((Double.parseDouble(Actual_CaseSize) * Double.parseDouble(Slab_Qty_2)) * Double.parseDouble(Actual_PiecePrice))
...
Mobile.verifyMatch(SchemeDesc, findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('SchemeDescSlab2', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(SchemeDesc + ' :Slab_2 Scheme Description correctly displayed !')

Discount_Perc_Sheet = findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue('DiscountPercSlab2', Scheme_Index)
