...
WebUI.click(findTestObject('XXXXXXXXXXXX/Web Part/Retailer Master/TreeFilter_Icon'), FailureHandling.OPTIONAL)

WebUI.mouseOver(findTestObject('XXXXXXXXXXXX/Web Part/Retailer Master/Search_Btn'), FailureHandling.OPTIONAL)
...
String MappedRetailerAttribute_Name = findTestData('Mobile Input Data/Attribute_Scheme').getValue('MappedRetailerAttribute_Name', Scheme_Index)

//RetailerAttribute_Name = MappedRetailerAttribute_Name.substring(0, 5)
RetailerAttribute_Name = MappedRetailerAttribute_Name
...
//			'Mobile Input Data/Attribute_Scheme').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input Data/Attribute_Scheme').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(SchemeName, findTestData('Mobile Input Data/Attribute_Scheme').getValue('SchemeName', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(SchemeName + ' : Slab_1 Scheme Name correctly applied !')

String actualText = SchemeDesc

String expectedText = findTestData('Mobile Input Data/Attribute_Scheme').getValue('SchemeDescSlab1', Scheme_Index)
...
Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/Attribute_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')

Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/Attribute_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/Attribute_Scheme').getValue('FreeProduct_Case_Slab1_MAX', Scheme_Index))
...
Mobile.verifyMatch(Slab1_FreeSku_PieceQty, findTestData('Mobile Input Data/Attribute_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
FreeProduct_Case_Slab1 = findTestData('Mobile Input Data/Attribute_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index)

SIH_BUY_SKU01 = (Integer.parseInt(Slab_1_Min_Qty + Integer.parseInt(FreeProduct_Case_Slab1)) * Integer.parseInt(Actual_CaseSize))
...
ExcelKeywords.setValueToCellByIndex(sheet1, 9, 5, SIH_BUY_SKU01)

ExcelKeywords.setValueToCellByIndex(sheet1, 10, 5, SIH_BUY_SKU02)
