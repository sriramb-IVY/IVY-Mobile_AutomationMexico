...
if (Mobile.verifyMatch(SchemeAppyNo, Expected_SchemeAppyNo, false, FailureHandling.STOP_ON_FAILURE)) {
    KeywordUtil.logInfo('For this Retailer "SchemeAppyNo" and "Expected_SchemeAppyNo" was Equal, hence we can validate scheme !')
        ...
        Mobile.verifyElementVisible(findTestObject('Mobile/OrderInvoice/Scheme/SchemeName'), 
			...
			Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1', 
			        Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
			...
			Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1', 
			    Scheme_Index))
			...
			Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1_MAX', 
			    Scheme_Index))
			...
			Slab1_FreeSku_Amt1 = Mobile.getText(findTestObject('Mobile/SummaryScreen/Summary_GetProductBasedTotalAmt(Global)'),5)
			...
			Slab1_FreeSku_Amt2 = Mobile.getText(findTestObject('Mobile/SummaryScreen/Summary_GetProductBasedTotalAmt(Global)'), 5)
			...
			Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('Mobile Input Data/RetailerTypeCreditNote_Scheme').getValue('FreeProduct02_Case_Slab1',
					Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
//			
//			Calculated_FreeProduct_Tax_Amt = Double.parseDouble(Slab1_FreeSku_Amt1) + Double.parseDouble(Slab1_FreeSku_Amt2)
//			
//			KeywordUtil.logInfo(Calculated_FreeProduct_Tax_Amt.toString())
			...
			Calculated_Order_Value = Total1 + Total2
