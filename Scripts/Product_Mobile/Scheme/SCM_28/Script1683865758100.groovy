...
//	
//	String Expected_location = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue('Location_name_mapping',
//		a + 1)
//
//	String expected_retailer_attribute = findTestData('Data Files/Mobile Input Data/Scheme_CriteriaMapping').getValue(
//		'Retailer_attribute_mapping', a + 1)
//
...
//
//	String scheme_mapped_retailer_attribute = GlobalVariable.Retailer_Attribute
//
//	String scheme_mapped_channel = GlobalVariable.Channel_name
//
//	WebUI.verifyMatch(scheme_Mapped_Location.substring(0, 6), Expected_location, false)
//
//	WebUI.verifyMatch(scheme_mapped_retailer_attribute.substring(0, 9), expected_retailer_attribute, false)
//
//	WebUI.verifyMatch(scheme_mapped_channel.substring(0, 12), Expected_channel, false)
//
//
//	WebUI.closeBrowser()
