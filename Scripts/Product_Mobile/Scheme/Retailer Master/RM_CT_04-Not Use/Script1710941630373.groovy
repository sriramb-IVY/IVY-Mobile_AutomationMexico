...
GlobalVariable.Brand_name = WebUI.getAttribute(findTestObject('Web Part/Product_Hierarchy/Get_Brand'), 'value')

KeywordUtil.logInfo('Brand name of the product is - ' + GlobalVariable.Brand_name)
