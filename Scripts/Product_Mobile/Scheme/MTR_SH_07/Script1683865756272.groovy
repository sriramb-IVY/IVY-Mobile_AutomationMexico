...
String Doubling_Slab_2_Max_Qty = Integer.parseInt(Slab_2_Max_Qty) * 2

GlobalVariable.Qty = Doubling_Slab_2_Max_Qty

KeywordUtil.logInfo(GlobalVariable.Qty + 'Doubling 2_Slab Max Qty')
...
Total = ((Double.parseDouble(Actual_CaseSize) * Double.parseDouble(Doubling_Slab_2_Max_Qty)) * Double.parseDouble(Actual_PiecePrice))
...
/////////////////
FreeSKU_Qty_Slab2_Sheet = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('FreeProduct_Case_Slab2', Scheme_Index)

Doubling_FreeSKU_Min_Qty_Slab2_Sheet = (Integer.parseInt(FreeSKU_Qty_Slab2_Sheet) * 2)

Mobile.verifyMatch(FreeSKU_Qty_Slab2, Doubling_FreeSKU_Min_Qty_Slab2_Sheet.toString(), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(Doubling_FreeSKU_Min_Qty_Slab2_Sheet + ' :Doubling Slab 2 Free Product Case Qty correctly displayed !')

//////////////
Expecetd_FreeSKU_MinQty_Slab2 = ('Min:' + Doubling_FreeSKU_Min_Qty_Slab2_Sheet)

Mobile.verifyMatch(FreeSKU_MinQty_Slab2.replaceAll('\\s', ''), Expecetd_FreeSKU_MinQty_Slab2, false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_MinQty_Slab2 + ' :Doubling Slab 2 Free Product Min Qty correctly displayed !')

//////////////////
FreeProduct_Case_Slab2_MAX = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('FreeProduct_Case_Slab2_MAX', Scheme_Index)

Doubling_FreeProduct_Case_Slab2_MAX_Sheet = (Integer.parseInt(FreeProduct_Case_Slab2_MAX) * 2)

Expecetd_FreeSKU_MaxQty_Slab2 = ('Max:' + Doubling_FreeProduct_Case_Slab2_MAX_Sheet)

Mobile.verifyMatch(FreeSKU_MaxQty_Slab2.replaceAll('\\s', ''), Expecetd_FreeSKU_MaxQty_Slab2, false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_MaxQty_Slab2 + ' :Doubling Slab 2 Free Product Max Qty correctly displayed !')
...
Mobile.verifyMatch(Slab2_FreeSku_CaseQty, Doubling_FreeSKU_Min_Qty_Slab2_Sheet.toString(), false, FailureHandling.STOP_ON_FAILURE)
