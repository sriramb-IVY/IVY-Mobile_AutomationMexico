...
KeywordUtil.logInfo(GlobalVariable.Qty + 'Doubling Slab 2 Max Qty')
...
GlobalVariable.ProductName = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('BuyProduct2', Scheme_Index)
...
Total2 = ((Double.parseDouble(Actual_CaseSize) * Double.parseDouble(GlobalVariable.Qty)) * Double.parseDouble(Actual_PiecePrice))
...
Discount_value_Sheet = findTestData('Mobile Input Data/MTR_MTS_Scheme').getValue('DiscounttValueSlab2', Scheme_Index)

Doubling_Discount_value_Sheet = (Double.parseDouble(Discount_value_Sheet) * 2)

Mobile.verifyEqual(Double.parseDouble(Discountvalue), Doubling_Discount_value_Sheet, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(Double.parseDouble(SchemeAmt), Doubling_Discount_value_Sheet, FailureHandling.STOP_ON_FAILURE)
