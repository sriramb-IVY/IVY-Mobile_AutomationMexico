...
//
//		//Veriyfing the scheme mapped data:-
...
//
//		WebUI.verifyNotMatch(scheme_Mapped_Retailer_Attribute.substring(0, 10), expected_retailer_attribute, false)
//
//		WebUI.closeBrowser()
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input Data/Scheme_CriteriaMapping').getValue(
...
KeywordUtil.logInfo('Scheme not apllied for this product because this retailer attribute is different with scheme mapped attribute')
