...
KeywordUtil.logInfo(Web_Addition_dis_Amt + ' : Additional discount Amount Displayed correctly in Screen Screen !')

Mobile.takeScreenshot()

Mobile.callTestCase(findTestCase('VBL_Mobile/Scheme/Reusable Cases/ANY_Condition_Free_Sku_Validation'), [('Scheme_Free_SKU') : findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Slab1', Scheme_Index), ('Scheme_Free_SKU02') : findTestData('Mobile Input Data/Combination_Scheme').getValue(
            'FreeProduct02_Slab1', Scheme_Index), ('FreeSKU_MinQty') : findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Case_Slab1', Scheme_Index), ('FreeSKU_MaxQty') : findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Case_Slab1_MAX', Scheme_Index)], 
...
//
//Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Case_Slab1', 
...
//
//Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Case_Slab1', 
//    Scheme_Index))
//
...
//
//Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct_Case_Slab1_MAX', 
//    Scheme_Index))
//
...
//KeywordUtil.logInfo(FreeProduct_Slab1 + ' :Slab 1 Free product correctly displayed !')
//
////Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/Combination_Scheme').getValue('FreeProduct02_Case_Slab1', Scheme_Index),
