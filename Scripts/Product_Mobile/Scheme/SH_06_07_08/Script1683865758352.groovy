...
GlobalVariable.keypadValue = findTestData('Mobile Input Data/OTPR').getValue('Slab_1_Min_Qty', Scheme_Index)

println(GlobalVariable.Qty = GlobalVariable.keypadValue)
...
GlobalVariable.keypadValue = findTestData('Mobile Input Data/OTPR').getValue('Slab_2_Min_Qty', Scheme_Index)
...
ExcelKeywords.setValueToCellByIndex(sheet1, 3, 6, invoice_ID)
...
WebUI.callTestCase(findTestCase('Product_Mobile/Common/Sync'), [:], FailureHandling.OPTIONAL)

WebUI.callTestCase(findTestCase('Product_Mobile/Common/HHT_Transaction_DB'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Product_Mobile/Scheme/Reusable Cases/DB_Sales_Invoice_SchAmt'), [:], FailureHandling.STOP_ON_FAILURE)
