...
RetailerApplyType = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('RetailerApplyType', Scheme_Index)

RetailerApplyType.toUpperCase()

KeywordUtil.logInfo(RetailerApplyType.toUpperCase())

SchemeAppyType = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('SchemeAppyType', Scheme_Index)

KeywordUtil.logInfo(SchemeAppyType)

if (SchemeAppyType.contains(RetailerApplyType.toUpperCase())) {
...
//            'Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('Product_Mobile/Common/TradeCoverage(SelectRetailer)'), [('RetailerName') : findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Retailer', Scheme_Index)], FailureHandling.STOP_ON_FAILURE)
...
'ANY_Logic'
GlobalVariable.ProductName = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('BuyProduct1', Scheme_Index)
...
GlobalVariable.keypadValue = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Slab_1_Min_Qty', Scheme_Index)

Slab_1_Min_Qty = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Slab_1_Min_Qty', Scheme_Index)
...
GlobalVariable.Scheme_Free_SKU = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Slab1', Scheme_Index)
...
CheckBox = Mobile.getAttribute(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/OrderInvoice/Scheme/Scheme_FreeProductQty_CheckBox'), 'checked', 1, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(SchemeName, findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('SchemeName', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(SchemeName + ' : Slab_1 Scheme Name correctly applied !')

Mobile.verifyMatch(SchemeDesc, findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('SchemeDescSlab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
Web_Addition_dis_Amt = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('Additional_Dis_Amt', Scheme_Index)
...
Mobile.verifyMatch(FreeSKU_Qty_Slab1, findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

KeywordUtil.logInfo(FreeSKU_Qty_Slab1 + ' :Slab 1 Free Product Case Qty correctly displayed !')

Expecetd_FreeSKU_MinQty_Slab1 = ('Min:' + findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', Scheme_Index))
...
Expecetd_FreeSKU_MaxQty_Slab1 = ('Max:' + findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1_MAX', Scheme_Index))
...
Mobile.verifyMatch(Slab1_FreeSku_CaseQty, findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', Scheme_Index), false, FailureHandling.STOP_ON_FAILURE)
...
IGST = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/SplitScreen-IGST Value'), 0)

TotalAmt = Mobile.getText(findTestObject('XXXXXXXXXXXX/Mobile Part/Store_Actvy/SummaryScreen/SliptScreen_TotalAmt'), 0)

Calculated_TotalAmt = ((Double.parseDouble(OrderAmt) + Double.parseDouble(IGST)) - Calculated_Scheme_Amt)
...
FreeProduct_Case_Slab1 = findTestData('Mobile Input Data/OTP_Automation_Scheme_CMB').getValue('FreeProduct_Case_Slab1', Scheme_Index)
