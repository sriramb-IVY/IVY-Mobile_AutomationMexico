...
queryString4 = (('select top 1 * from appdata_collection where c_sih_no=\'' + GlobalVariable.Transaction_No) + '\' and C_Cheque_No != 12345 and C_ReferenceNo not like \'' + CR + '\'')

//queryString4 = ('select top 1 * from appdata_collection ')
...
WebUI.verifyMatch(paymentype,  findTestData('Mobile Input Data/Collection').getValue('Mode_of_Collection_1', 1), false, FailureHandling.STOP_ON_FAILURE)
