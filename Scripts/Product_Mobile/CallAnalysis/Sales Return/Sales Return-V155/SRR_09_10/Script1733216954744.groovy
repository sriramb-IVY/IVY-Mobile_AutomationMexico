...
Reason2 = Mobile.getText(findTestObject('Mobile/SalesReturn/Expired-option'), 0)
...
'First Product'
GlobalVariable.label=findTestData('Mobile Input Data/SalesReturn_Replacement').getValue('Return_SKU_Name', 2)

Mobile.verifyElementExist(findTestObject('Mobile/SalesReturn/ProductName_Global'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Mobile/SalesReturn/SR-Reason'), Reason, FailureHandling.STOP_ON_FAILURE)

'Second Product'
GlobalVariable.label=GlobalVariable.S_Sku_Name

Mobile.verifyElementExist(findTestObject('Mobile/SalesReturn/ProductName_Global'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Mobile/SalesReturn/SR-Reason_2'), Reason2, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('Able to add two different product for sales return')
