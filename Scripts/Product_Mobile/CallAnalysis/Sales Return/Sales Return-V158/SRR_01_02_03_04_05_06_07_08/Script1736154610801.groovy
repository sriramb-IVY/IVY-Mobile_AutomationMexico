...
Mobile.setText(findTestObject('Mobile/SalesReturn/Return-InvoiceNo'), findTestData('Mobile Input Data/CallAnalysis').getValue(
...
a = Mobile.getAttribute(findTestObject('Mobile/SalesReturn/Return-Select Reason'), 'x', 
    2, FailureHandling.OPTIONAL)

b = Mobile.getAttribute(findTestObject('Mobile/SalesReturn/Return-Select Reason'), 'y', 
    2, FailureHandling.OPTIONAL)
...
Total_Return_amount_Returnscrn = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Return_product_amount'), 
    0)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Mobile/Seller_2/SalesReturn_Replacement/Replace_title_tab'), 
    0)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Object Repository/Mobile/Seller_2/SalesReturn_Replacement/Replace_title_tab'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Common/Field_Search_EnterText'), 
    0)

Mobile.takeScreenshot()

X_val = Mobile.getAttribute(findTestObject('Mobile/Common/Field_Search_EnterText'), 
    'x', 0)

Y_val = Mobile.getAttribute(findTestObject('Mobile/Common/Field_Search_EnterText'), 
    'y', 0)
...
Mobile.setText(findTestObject('Mobile/Common/Field_Search_EnterText'), 
    Replacement_sku1, 0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Search_clear_btn'), 
    0)
...
After_clear_the_text = Mobile.getText(findTestObject('Mobile/Common/Field_Search_EnterText'), 
    0)
...
Replace_product_name = Mobile.getText(findTestObject('Object Repository/Mobile/Seller_2/SalesReturn_Replacement/Replacement_Product_Name_get'), 
    0)
...
Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Price_Get_VT'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Value_Get_VT'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Case_field'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Piece_field'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_product_remove_btn'), 
    0)
...
Mobile.setText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Case_field'), findTestData(
        'Mobile Input Data/SalesReturn_Replacement').getValue('Qty', 1), 0)

Case_qty = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Case_field'), 
    0)
...
Mobile.setText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Piece_field'), findTestData(
        'Mobile Input Data/SalesReturn_Replacement').getValue('Qty', 2), 0)

Piece_qty = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Piece_field'), 
    0)
...
Price = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Price_Get_VT'), 
    0)
...
Replace_value = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Value_Get_VT'), 
    0)
...
Mobile.tap(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_product_remove_btn'), 
    0)

Mobile.verifyElementNotExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Product_Name_get'), 
    0)
...
SKU1_Pri = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Price_Get_VT'), 
    0)
...
println(SKU1_rep_amt)

SKU1_Replace_piece = SKU1_rep_amt.round()

String SKU1_Replace_piece_qty = SKU1_Replace_piece

KeywordUtil.logInfo(SKU1_Replace_piece_qty + ' : replacement qty ')

Mobile.tap(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Piece_field'), 0)

Mobile.setText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Piece_field'), SKU1_Replace_piece_qty, 
    0)

Mobile.tap(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Case_field'), 0)

SKU1_Replace_value = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Value_Get_VT'), 
    0)
...
if (Mobile.verifyElementNotExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Price_Get_VT'), 
    5, FailureHandling.OPTIONAL)) {
    GlobalVariable.label = findTestData('Mobile Input Data/SalesReturn_Replacement').getValue('Replacement_SKU_Name', 2)

    Mobile.tap(findTestObject('Object Repository/Mobile/Seller_2/SalesReturn_Replacement/Search_clear_btn'), 
        0, FailureHandling.OPTIONAL)

    Mobile.tap(findTestObject('Mobile/Common/Field_Search_EnterText'), 
        0)
...
SKU2_Pri = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Price_Get_VT'), 
    0)
...
Mobile.setText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Piece_field'), SKU2_Replace_piece_qty, 
    0)
...
SKU2_Replace_value = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Value_Get_VT'), 
    0)
...
//GlobalVariable.label = findTestData('Mobile Input Data/SalesReturn_Replacement').getValue('Replacement_SKU_Name', 1)
//
//KeywordUtil.logInfo(GlobalVariable.label + ' :product')
//Mobile.delay(2)
//
//Mobile.tap(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Replacement_Piece_field'), 0)
//
...
Total_rep_quantity = Mobile.getText(findTestObject('Object Repository/Mobile/Seller_2/SalesReturn_Replacement/Replacement_qty_get'), 
    0)

Total_rep_valuee = Mobile.getText(findTestObject('Object Repository/Mobile/Seller_2/SalesReturn_Replacement/Replacement_bottom_value_get'), 
    0)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Replacement_title_summary_screen'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Replacement_piece_get_sum_scrn'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Replacement_case_get_sum_scrn'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Replacement_Product_Price_sum_scrn'), 
    0)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Replacement_value_sum_scrn'), 
    0)

Mobile.takeScreenshot()

Summary_Total_replace_value = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Total_Replacement_value_get_sum_scrn'), 
    0)

Summary_Total_return_value = Mobile.getText(findTestObject('Mobile/SalesReturn/SR-TotalValue - 2'), 
    0)
...
Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Confirm_Credit_Note_Generation_Alert'), 
    3, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Replacement_credit_note_generation_msg'), 
    3, FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Validation for credit note generation alert text')

Credit_Note_Alert = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/Summary_Screen/Alert_Get'), 
    0)

Mobile.verifyMatch(Credit_Note_Alert, findTestData('Mobile Input Data/SalesReturn_Replacement').getValue('Alerts', 2), false, 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Mobile/SalesReturn/SR-Saved Successfully'), 3, 
...
Mobile.verifyElementVisible(findTestObject('Mobile/Collection/CreditNote/Credit Note Screen_Title'), 
    0)
...
Mobile.verifyElementVisible(findTestObject('Mobile/Seller_2/Collection_CreditNote/Credit_Note_Amt_get_collection_scren'), 
    0)
...
CreditNote_id = Mobile.getText(findTestObject('Mobile/Seller_2/Collection_CreditNote/Credit_Note_Id_get_collection_scrn'), 
    0)

SalesReturnId = Mobile.getText(findTestObject('Mobile/Seller_2/Collection_CreditNote/SalesReturn_Id_get_collection_scrn'), 
    0)
