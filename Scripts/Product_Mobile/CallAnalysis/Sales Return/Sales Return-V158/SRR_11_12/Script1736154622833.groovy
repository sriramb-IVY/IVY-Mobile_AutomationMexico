...
Price = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Price_Get_VT'), 0)
...
Replace_value = Mobile.getText(findTestObject('Mobile/Seller_2/SalesReturn_Replacement/ReplacementV158/Replacement_Value_Get_VT'), 0)
...
Mobile.verifyMatch(Rep_edit_alert, findTestData('Mobile Input Data/SalesReturn_Replacement').getValue('Alerts', 3), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Object Repository/Mobile/Common/Icon_Back'), 0, FailureHandling.OPTIONAL)

Mobile.tap(findTestObject('Mobile/Common/Btn_Cancel'), 3, FailureHandling.OPTIONAL)

Mobile.delay(2)

Mobile.tap(findTestObject('Mobile/Common/Icon_X'), 2)
