...
public class Limit_period_bill_increase {
	...
	public  String Credit_Limit(def retailer_Code ){
		...
		String queryString1 = ('update ADM_Retailer_Mapping set ARM_Credit_Limit = 5000 where ARM_ARTR_Id = \'' + GlobalVariable.Retailer_Id +'\'')
	...
	public static String increase_Warn_CP(def retailer_Code){
		...
		String queryString1 = ('update ADM_Retailer_Mapping set ARM_Warn_Credit_Period = 2 where ARM_ARTR_Id = \'' + GlobalVariable.Retailer_Id +'\'')
